...
case 'edit_obs_oco':
    ...
    $query2 = "UPDATE rotas SET obs_ocorrencia='$texto' where id='$id'";
    $rs2 = mysql_query($query2);
	...
	<td><img src="imgs/ok.PNG"/>
		<br>
	<strong>OBSERVAÇÃO INSERIDA COM SUCESSO!</strong>	
		</td>
	</tr>
...
case 'envia_emails':
        ...
        for ($i = 0; $i < $conta_lista; $i++) {
            ...
            $query20 = "SELECT * FROM rotas WHERE id='$campo[$i]'";
            $rs20 = mysql_query($query20);

            $grava_email_foi = mysql_query("UPDATE rotas SET email_chegou=1 where id='$campo[$i]'");

            while ($row20 = mysql_fetch_array($rs20)) {

                $emails = $row20['emails'];
                $obs_pedido = $row20['obs'];

                
                // Exibição
                $oco= $row20['ocorrencia'];
        ...
        <div style="height:100%;background-color:#FFFFFF; width:400px; position: relative; top: 50%; margin-top:-50px; left:50%; margin-left:-200px">
        ...
        <?php
           // print_r($array_oco);
            ...
            try {
                ...
                if($array_oco[$i]=='20'){
                $assunto = '=?UTF-8?B?'.base64_encode('SUPERBRILHO: Você recebeu seu pedido com uma ocorrência!').'?=';
                }				
                $mail1->isHTML(true);
                ...
                if($array_oco[$i]=='20'){
                    ...
                    <center><table border=0 style='height:200px; background-color: #FFF; align:center'>
                    <tr><td align=right style='height:150px;padding-right:48px'><img src='http://191.252.59.75/saas/MO2.0/CLT/STD/src/imgs/image-4.png' ></td></tr>
                    <tr><td align=center><img src='http://191.252.59.75/saas/MO2.0/CLT/STD/src/imgs/image-7.png'></td></tr>
                    <tr><td align=center><span style='margin: 0px; text-align: center; font-family: Open Sans; font-size: 43px; font-weight: 400;'><strong>Seu pedido chegou!</strong></span></td></tr>
                    <tr><td align=center style='padding-left:15px;padding-right:15px;color:#000;font-family: Open Sans; height:100px '>Seu pedido foi entregue com uma ocorr&ecirc;ncia! <br>Estamos trabalhando para resolu&ccedil;&acirc;o do problema!<br><br>Para maiores esclarecimentos entre em contato com nosso SAC.</td></tr>
                    <tr><td  align=center style='height:50px'><img src='http://191.252.59.75/saas/MO2.0/CLT/STD/src/imgs/image-3.png'></td></tr>
                    <tr><td align=center style='padding-left:15px;padding-right:15px; color:#000; background-color: #16689e;color:#fff;font-family: Open Sans; height:80px '><strong>As melhores cestas b&aacute;sicas para sua empresa e sua fam&iacute;lia!</strong></td></tr>
                    <tr><td  align=center><a href='https://web.whatsapp.com/send?phone=5511910209020'><img src='http://191.252.59.75/saas/MO2.0/CLT/STD/src/imgs/image-2.png'></a>&nbsp;&nbsp;&nbsp;<a href='tel:+551121812050'><img src='http://191.252.59.75/saas/MO2.0/CLT/STD/src/imgs/image-5.png'></td></tr>
                    </table></center></body>";
            ...
            echo "<div style='position:absolute;margin:0px 0px 0px 0px;width:100%;height:100%;background:#2867b2;color:#2867b2;color: #FFFFFF;text-align:center;line-height:40px;'>$pega_loading</div>";
            flush();
            ob_flush();
...
case 'edita_lista_nome':
    ...
    $verifica_nome_lista = mysql_query("SELECT nome from listas where nome='$id'");
    $num_rows = mysql_num_rows($verifica_nome_lista);
    //echo $num_rows;
    ...
    if($num_rows>0){
        ...
        ?>    
        <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        alert("Escolha outro nome para a lista. Essa lista já existe no sistema."); 
        </SCRIPT>
        <?php
        } 
        ?>
...
/////////////IMPORTAR ROTAS ONLINE PORTA A PORTA ////////////////////////////////

case 'importar_rotaonline_pp':
...
$dia_seguinte =  date("d-m-y");
    
$new = "ro_" . $logado . "_pp";


$lista = $dia_seguinte  . "-PORTA A PORTA-(" . $today1 . ")";
    ...
    while ($row20 = mysql_fetch_array($rs20)) {
        ...
        $nome_veiculo = $row20['nome_veiculo'];

        $rota = $dia_seguinte . " " . $nome_veiculo ." (". $rota_pega . ")" . "PP";
...
$lista = $dia_seguinte . " (" . $today1 . ")";
    ...
    while ($row20 = mysql_fetch_array($rs20)) {
        ...
        $rota = $dia_seguinte . " " . $nome_veiculo ." (". $rota_pega . ")";
...
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        $query2 = "INSERT INTO usuario (login, senha, coordenador, nivel, lat, lgn, time_trail) VALUES ('$lg', '$pss', '$coord',  2, '$lat', '$lgn', 300)";
        $rs2 = mysql_query($query2);
...
//echo $pss;
    ...
    $query2 = "UPDATE usuario SET senha='$pss', coordenador='$coord' WHERE login='$lg'";
    $rs2 = mysql_query($query2);
