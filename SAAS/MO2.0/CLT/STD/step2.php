...
document.getElementById("pag2").src = teste; 
  ...
  function acao_edit_oco(id_pedido) {
	
  document.getElementById("Pagina").style.display = "block";
  
  var teste = "step2_edit_oco.php?id_pedido=";

      teste = teste + id_pedido;
...
document.getElementById("Pagina_email_x").style.display = "block";

var teste = "step2_emails.php?";
...
for (var i=0; i < radios.length; i++) {
 ...
 document.getElementById("pag2_e_x").src = teste; 
...
//alert(lista_ordem);
 ...
 document.getElementById("pag2").src = teste; 
    ...
    var x = document.getElementById("login_exp").value;
    var y = document.getElementById("lista_exp").value;
    var z = document.getElementById("ocorrencia_exp").value;
    //  alert(x);
    //  alert(y);
    //  alert(z);

        var teste = "testeXlsx.php" + '?login_exp=' + x + '&lista_exp=' + y + '&ocorrencia_exp=' + z;
...
function mail(aURL) {
  ...
  document.getElementById("Pagina_mail").style.display = "block";

  document.getElementById("Pagina_mail").style.backgroundColor = "lightblue";

        var teste = aURL;


 document.getElementById("pag2_mail").src = teste;
...
if($string4!=""){
    ...
    $query = "select * from rotas where codigo_pedido LIKE '%$string4%' order by nome, dth_ocorrencia DESC";

    $query_pizza1 = "select id from rotas where status=1 AND codigo_pedido like '%$string4%'";													
    $rs_pizza1 = mysql_query($query_pizza1);
    $num_rows_pizza1 = mysql_num_rows($rs_pizza1);
   
    
    $query_pizza2 = "select id from rotas where status=2 AND codigo_pedido like '%$string4%'";															
    $rs_pizza2 = mysql_query($query_pizza2);
    $num_rows_pizza2 = mysql_num_rows($rs_pizza2);
  
    
    
    $query_pizza3 = "select id from rotas where status=0 AND codigo_pedido like '%$string4%'";															
    $rs_pizza3 = mysql_query($query_pizza3);
    $num_rows_pizza3 = mysql_num_rows($rs_pizza3);
  
    
    $query_pizza4 = "select id from rotas where status=3 AND codigo_pedido like '%$string4%'";														
    $rs_pizza4 = mysql_query($query_pizza4);
    $num_rows_pizza4 = mysql_num_rows($rs_pizza4);
  
    $aviso_listatual = " &#x2022; POR PEDIDO";
  ...
  $query = "select * from rotas where obs LIKE '%$string5%' order by nome, dth_ocorrencia DESC";

  $query_pizza1 = "select id from rotas where status=1 AND obs like '%$string5%'";													
  $rs_pizza1 = mysql_query($query_pizza1);
  $num_rows_pizza1 = mysql_num_rows($rs_pizza1);
 
  
  $query_pizza2 = "select id from rotas where status=2 AND obs like '%$string5%'";															
  $rs_pizza2 = mysql_query($query_pizza2);
  $num_rows_pizza2 = mysql_num_rows($rs_pizza2);

  
  
  $query_pizza3 = "select id from rotas where status=0 AND obs like '%$string5%'";															
  $rs_pizza3 = mysql_query($query_pizza3);
  $num_rows_pizza3 = mysql_num_rows($rs_pizza3);

  
  $query_pizza4 = "select id from rotas where status=3 AND obs like '%$string5%'";														
  $rs_pizza4 = mysql_query($query_pizza4);
  $num_rows_pizza4 = mysql_num_rows($rs_pizza4);

  $aviso_listatual = " &#x2022; POR NOTA";
...
if($logado=='superbrilho'){
	...
	<td  nowrap="nowrap" style="width: 15px">
			...
			<i class="material-icons" style="font-size:24px; vertical-align:bottom">mail</i>
		
    </td>
    <td nowrap="nowrap">
    <a href="javascript:acao9();">
    <font size="2">&nbsp;&nbsp;ENVIAR EMAILS</font>
    </a>
    </td>
    </tr>
    <?php
...
if($logado=='superbrilho'){
?>
<form name="search_form2" method="POST" action="step2.php">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" style="padding-top: 25px; padding-bottom: 8px; width:360px" >
		<tr>
            ...
            <strong><font size="4">&nbsp;FILTRAR POR NOTA</font></strong>
            </td>
	   </tr>
		</table>
    <hr size = 1 width = '200px' color="#DCDCDC">
      ...
      <tr>
          <td nowrap="nowrap" height="30px" bgcolor="#ECECEC" style="padding-left: 10px;">
            <i class="material-icons" style="font-size:22px; vertical-align:bottom">&#xe853;</i><font size="2"> Nota</font>
          </td>	
      </tr>
        <tr >
    
          <td> 
            <input type="text" value="" name="nota" id="nota" style="width: 328px; height:25px; border-width: 0.5px;border-color: #eee;">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" style="padding-top: 25px; padding-bottom: 8px; width:360px" >
		<tr>
            ...
            <strong><font size="4">&nbsp;FILTRAR POR PEDIDO</font></strong>
            </td>
	   </tr>
		</table>
    <hr size = 1 width = '200px' color="#DCDCDC">
      ...
      <tr>
          <td nowrap="nowrap" height="30px" bgcolor="#ECECEC" style="padding-left: 10px;">
            <i class="material-icons" style="font-size:22px; vertical-align:bottom">&#xe853;</i><font size="2"> Pedido</font>
          </td>	
      </tr>
        <tr >
...
<input type="text"  value="<?php echo "'" .implode("','", $campo0) . "'"; ?>" name="login_exp" id="login_exp" hidden />
<input type="text"  value="<?php echo "'" .implode("','", $campo1) . "'"; ?>" name="lista_exp" id="lista_exp" hidden/>
<input type="text"  value="<?php echo "'" .implode("','", $campo3) . "'"; ?>" name="ocorrencia_exp" id="ocorrencia_exp" hidden/>
...
?>
    ...
    if($pieces[$i2]=="codigo_pedido"){
     ...
     if($pieces[$i2]=="emails"){
      ?>
              <div align="center" >ENVIAR EMAIL</div>
              <?php
   } 
   if($pieces[$i2]=="email_a_caminho"){
    ?>
            <div align="center" >EMAIL A CAMINHO</div>
            <?php
 } 
 if($pieces[$i2]=="email_chegou"){
  ?>
          <div align="center" >EMAIL CHEGOU</div>
          <?php
} 
if($pieces[$i2]!="edit_oco" AND $pieces[$i2]!="email_chegou" AND $pieces[$i2]!="email_a_caminho" AND $pieces[$i2]!="emails" AND $pieces[$i2]!="check" AND $pieces[$i2]!="status" AND $pieces[$i2]!="foto" AND $pieces[$i2]!="geo" AND $pieces[$i2]!="foto" AND $pieces[$i2]!="edit" AND $pieces[$i2]!="exclui" AND $pieces[$i2]!="localiza" AND $pieces[$i2]!="sequencia" AND $pieces[$i2]!="codigo_pedido" AND $pieces[$i2]!="quem" AND $pieces[$i2]!="canhoto" AND $pieces[$i2]!="classificacao"){
?>
...
if($pieces[$i1]=="emails"){
  ...
  ?>
<td align="center" style="width: 20px"><a href="javascript:mail('step2_mail.php?mail=<?=$row["emails"]?>&nota=<?=$row["obs"]?>&id=<?=$row["id"]?>')" data-tooltip="Enviar email">
<?php
 if($row["email_chegou"]!="1" AND ($row["ocorrencia"]=="1" OR $row["ocorrencia"]=="20")){
?>
<i class="material-icons" style="font-size:16px;color:red">mail</i></a>
<?php
 }
?>
</td>  
  <?php
      ...
      if($pieces[$i1]=="edit_oco"){

        if($row["status"] == 2 OR $row["status"] == 3){
?>

<td align="center" style="width: 20px"><a href="javascript:acao_edit_oco(<?php echo $row["id"];?>);"><i class="material-icons" style="font-size:16px">&#xe560;</i></a></td>  
...
if($pieces[$i1]=="obs_ocorrencia"){
  ?> 
 <td align="center" nowrap="nowrap"  width="auto"> 
<?php 
if($row["obs_ocorrencia"]=="" AND $row["status"] == 2 OR $row["obs_ocorrencia"]=="" AND $row["status"] == 3){
?>
<Span style="color: orange;"><strong>VERIFICAR</strong></Span>
<?php
} else {
?>

<Span style="color: green;"><strong><?php echo $row["obs_ocorrencia"] ?></strong></Span>
<?php
}
?>
</td> 
...
if($pieces[$i1]=="email_a_caminho"){
  ?> 
 <td align="center" nowrap="nowrap"  width="auto"> 
<?php 
if($row["email_a_caminho"]=="1"){
?>
...
?>
 ...
 <?php
      ...
      if($pieces[$i1]=="email_chegou"){
        ?> 
       <td align="center" nowrap="nowrap"  width="auto"> 
    <?php 
    if($row["email_chegou"]=="1"){
    ?>
    <i class='material-icons' style='font-size:16px;color: green;'>thumb_up</i>
    <?php
    }
...
if($pieces[$i1]!="obs_ocorrencia" AND $pieces[$i1]!="edit_oco" AND $pieces[$i1]!="email_chegou" AND $pieces[$i1]!="email_a_caminho" AND $pieces[$i1]!="emails" AND $pieces[$i1]!="check" AND $pieces[$i1]!="status" AND $pieces[$i1]!="geo" AND $pieces[$i1]!="foto" AND $pieces[$i1]!="edit" AND $pieces[$i1]!="exclui" AND $pieces[$i1]!="localiza" AND $pieces[$i1]!="codigo_pedido" AND $pieces[$i1]!="ocorrencia" AND $pieces[$i1]!="tempo" AND $pieces[$i1]!="ce" AND $pieces[$i1]!="p.o" AND $pieces[$i1]!="canhoto"){
?>
...
if($string0=="" AND $string1=="" AND $string3=="") {
  ...
  if($string4!=""){
    $completa0 = " AND codigo_pedido like '%$string4%'";
  } elseif($string5!=""){
    $completa0 = " AND obs like '%$string5%'";
} else {
...
<div id="Pagina_mail" style="display: none">

    <iframe name="pag1_mail" frameborder="0" id="pag1_mail" scrolling="no" marginheight="0" marginwidth="0" trusted="yes"></iframe>
   <iframe name="pag2_mail" src="" frameborder=0 id="pag2_mail" scrolling="no" marginheight="0" marginwidth="0" trusted="yes"></iframe>
</div>     

<div id="Pagina_email_x" style="display: none;">
	  
  
    <iframe name="pag1_e_x" frameborder="0" id="pag1_e_x" scrolling="no" marginheight="0" marginwidth="0" trusted="yes"></iframe>
   <iframe name="pag2_e_x" src="" frameborder=0 id="pag2_e_x" scrolling="no" marginheight="0" marginwidth="0" trusted="yes"> </iframe>
</div> 
