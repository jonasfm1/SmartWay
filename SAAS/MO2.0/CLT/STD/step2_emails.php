...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#579bd3; font-size: 11px; color: white" >
    <tr>
		<td align="left" valign="center" colspan="3" height="50px"><i class="material-icons" style="font-size:22px; vertical-align:bottom;padding-left: 15px;">download</i><strong><font size="2px">&nbsp;ENVIAR EMAILS</strong>  
      </td>
    </tr>
</table>
</div>
...
<form action="scripts.php?acao=envia_emails" method="POST" name="envia" id="envia">
<?php
...
<?php		  
     ...
     //  echo $campo[$i];
     $query20 = "SELECT * FROM rotas WHERE id='$campo[$i]' and email_chegou=0 AND (ocorrencia='1' or ocorrencia='20')";
     $rs20 = mysql_query($query20);
     $dados = mysql_fetch_array($rs20);
     $num_rows = mysql_num_rows($rs20);
...
<td align="center" width="100%">
	...
	<label class="container"><i class="material-icons" style="font-size:24px; vertical-align:middle; color: red; align-content: center; padding-right: 3px; padding-left: 10px">mail</i>



	<span style="vertical-align:inherit"><?php echo  "Pedido: " . $obs; ?></span>
 
  <input type="checkbox" name="check_list1[]" id="check_list1" value="<?php echo  $id_cli; ?>" checked="checked">
