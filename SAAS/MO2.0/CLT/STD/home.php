...
if ($import==3) {
    ...
    <td>
            <a href="scripts.php?acao=importar_rotaonline"><input type="submit" name="submit" id="submit" value="IMPORTAR LISTA"/></a>
            <a href="scripts.php?acao=importar_rotaonline_pp"><input type="submit" name="submit" id="submit" value="IMPORTAR PP"/></a>
    </td>
...
<?php
    if ($row1["site"]==0){
        ...
        ?>
        <a href="scripts.php?acao=ativa_site&id=<?php echo $row1["lista"]; ?>">  <i class="material-icons" style="font-size:20px;color:black" block>check_box_outline_blank</i></a>
        <?php
         } 
