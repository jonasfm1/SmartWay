...
if($string0=="" AND $string1!="" AND $string3==""){
 ...
 //   $vaivai = "CREATE INDEX lista_controle ON rotas(lista)";
 //   $vaivai2 = "CREATE INDEX rota_controle ON rotas(rota)";

    $query = "select * from rotas USE INDEX(lista) where lista in($string1)";
   // $query_teste = "alter table rotas add index (id)";
...
//$rs_teste =  mysql_query($query_teste);

//$vaivai = mysql_query($vaivai);
//$vaivai2 = mysql_query($vaivai2);
	...
	<tr>
			<td><select name="lang0pt1[]" multiple id="lang0pt1">
                <?php
                    ...
                    $result1 = mysql_query("select DISTINCT lista from rotas where site=1 order by id DESC");
...
<div style="height:100%; background-color:#FFFFFF; width:100%; position: relative;">
...
<table border="3" id="demo" name="demo" class="tablesorter" width="100%" style="font-size:11px;">
<thead>
...
if($row["canhoto"]=="1"){
?>
<i class='material-icons' style='font-size:14px;color: green;'>thumb_up</i>
<?php
}
?>
...
//// LOADING 0 A 100% ////////////////////////////////////////////////////
    ...
    <?php
    echo "<div id='fdp' style='position:absolute;margin:0px 0px 0px 0px;width:$pega_loading;height:30px;background:#CCCCCC;color:#FFFFFF;text-align:center;line-height:30px;'>$pega_loading</div>";
    flush();
    ob_flush();
	?>
    </div>
