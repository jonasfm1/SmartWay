...
<td><strong><font size="4">IMPORTAR LISTA!</font></strong></td>
</tr>

<tr style="height: 25px;vertical-align: top">
<td><hr style="border: none; width:150px;" ></td>
</tr>

<tr>
<td>
		<a href="scripts.php?acao=importar_rotaonline"><input type="submit" name="submit" id="submit" value="IMPORTAR LISTA"/></a>
</td>
</tr>
 <?php
}
...
<tr>
<td>
<a href="scripts.php?acao=importar_rotaonline&usuario=slt_gsp1"><input type="submit" name="submit" id="submit" value="IMPORTAR GSP1"/></a>
<a href="scripts.php?acao=importar_rotaonline&usuario=slt_gsp2"><input type="submit" name="submit" id="submit" value="IMPORTAR GSP2"/></a>
<a href="scripts.php?acao=importar_rotaonline&usuario=slt_i1"><input type="submit" name="submit" id="submit" value="IMPORTAR I1"/></a>
...
<tr>
<td>
         <a href="scripts.php?acao=importar_rotaonline&usuario=slt_i2"><input type="submit" name="submit" id="submit" value="IMPORTAR I2"/></a>
         </td>
</tr>
     <?php
        } 
...
<table width="654px" border="1" cellspacing="0" cellpadding="0" class="bordasimples">
