...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#579bd3; font-size: 11px; color: white" >
    <tr>
		<td align="left" valign="center" colspan="3" height="50px"><i class="material-icons" style="font-size:22px; vertical-align:bottom;padding-left: 15px;">&#xe52e;</i><strong><font size="2px">&nbsp;ALTERAR ROTA</strong>  
      </td>
    </tr>
</table>
</div>
...
//echo $procurando;
 if($procurando!=""){
  ...
  $query1 = "select * from rotas where rota like '%$procurando%' group by rota order by rota DESC";															
...
?>
  ...
  <form action="step2_sm_ro.php" method="GET" name="procura" id="procura">
<?php
		 for ($i = 0; $i < $conta_lista; $i++) {
			?>
...
<form action="scripts.php?acao=altera_rota_site" method="POST" name="envia" id="envia" onsubmit="return verificar();">
...
<td align="center" width="100%">
	...
	<label class="container"><i class="material-icons" style="font-size:24px; vertical-align:middle; color: grey; align-content: center; padding-right: 3px; padding-left: 10px">&#xe52e;</i>

	
	<span style="vertical-align:inherit"><?php echo $row1["rota"];?></span>
  <input type="radio" value="<?php echo $row1["rota"];?>" name="RadioGroup1"  id="RadioGroup1">
