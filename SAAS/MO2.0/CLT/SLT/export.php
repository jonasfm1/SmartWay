...
if($string0 != "''" AND $string1 =="''" AND $string3 =="''"){
    ...
    $query = "select * from rotas where login in($string0) and remetente='$remetente' order by login, lista, rota, sequencia, ocorrencia";
...
if($string0 =="''" AND $string1 != "''" AND $string3 =="''"){
    ...
    $query = "select * from rotas where id_lista in($string1) and remetente='$remetente' order by login, lista, rota, sequencia, ocorrencia";
...
if($string0 =="''" AND $string1 =="''" AND $string3 != "''"){
    ...
    $query = "select * from rotas where status in($string3) and remetente='$remetente' order by login, lista, rota, sequencia, ocorrencia";
...
if($string0 != "''" AND $string1 != "''" AND $string3 =="''"){
    ...
    $query = "select * from rotas where login in($string0) AND id_lista in($string1) and remetente='$remetente' order by login, lista, rota, sequencia, ocorrencia";
...
if($string0 == "''" AND $string1 != "''" AND $string3 !="''"){
    ...
    $query = "select * from rotas where id_lista in($string1) AND status in($string3) and remetente='$remetente' order by login, lista, rota, sequencia, ocorrencia";
...
if($string0 != "''" AND $string1 == "''" AND $string3 !="''"){
    ...
    $query = "select * from rotas where login in($string0) AND status in($string3) and remetente='$remetente' order by login, lista, rota, sequencia, ocorrencia";
 //   echo "entrou lista, ocorrencia";
}
...
if($string0 != "''" AND $string1 != "''" AND $string3 !="''"){
    ...
    $query = "select * from rotas where login in($string0) AND id_lista in($string1) AND status in($string3) and remetente='$remetente' order by login, lista, rota, sequencia, ocorrencia";
...
if($string0 =="''" AND $string1 =="''" AND $string3 =="''" ){
    ...
    $query = "select * from rotas where statusrota=1 and remetente='$remetente' order by login, lista, rota, sequencia, ocorrencia";
...
$html .= '<td><b>CANHOTO</b></td>';
$html .= '<td><b>DT. CANHOTO</b></td>';
...
$obs = $datas['obs'];
$canhoto_confere = $datas['canhoto'];

if($canhoto_confere == 1){
$canhoto="CONFERIDO";
} else {
$canhoto="NÃO CONFERIDO";

}
$canhoto_quem = $datas['quem'];
$data_canhoto = $datas['data_canhoto'];
$lista = $datas['lista'];
$motorista = $datas['motorista'];
...
$html .= '<td>' . $classe . '</td>';
$html .= '<td>' . $canhoto . '</td>';
$html .= '<td>' . $data_canhoto . '</td>';
$html .= '<td>' . $canhoto_quem . '</td>';
$html .= '<td>' . $peso . '</td>';
$html .= '<td>' . $valor . '</td>';
$html .= '</tr>';
