...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#579bd3; font-size: 11px; color: white" >
    <tr>
		<td align="left" valign="center" colspan="3" height="50px"><i class="material-icons" style="font-size:22px; vertical-align:bottom;padding-left: 15px;">&#xe52e;</i><strong><font size="2px">&nbsp;LISTA DE ARQUIVOS EXPORTADOS</strong>  
      </td>
    </tr>
</table>
</div>
...
<td align="center" width="100%">
	...
	<span style="vertical-align:inherit"><?php echo "<a href='uploads/". $logado . "/" .$valorArquivos."'>".$valorArquivos."</a><br />"; ?></span>
