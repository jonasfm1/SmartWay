...
//echo "eita";
?>
<li style="background-color: #2867b2; color: #154B8B"><a href="controle_de_lista.php" target="_self">Controle de Lista por data</a></li> 
 <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LOGOFF</li>  
<?php
...
<div id="apDiv3">
<div id="mouse"><span style="cursor:pointer" onclick="openNav()"><img src="imgs/logo_min.png" width="76" height="33" alt=""/></span></div>