...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#579bd3; font-size: 11px; color: white" >
    <tr>
		<td align="left" valign="center" colspan="3" height="50px"><i class="material-icons" style="font-size:22px; vertical-align:bottom;padding-left: 15px;">remove_red_eye</i><strong><font size="2px">&nbsp;ADICIONAR SUB NATUREZA</strong>  
      </td>
    </tr>
</table>
</div>
 <div id="total">
      ...
      <form action="scripts.php?acao=adiciona_sub_app" method="POST" name="envia" id="envia">
...
<td style="height: 40px;">
    Digite abaixo a Sub natureza e clique em Aplicar.
</td>
</tr>
<tr >
...
<option value="EMBALAGEM AVARIADA">EMBALAGEM AVARIADA</option>
...
<option value="FALHA NO FATURAMENTO">FALHA NO FATURAMENTO</option>
<option value="CADASTRO INCORRETO">CADASTRO INCORRETO</option>
<option value="MERCADORIA SEM PEDIDO">MERCADORIA SEM PEDIDO</option>
<option value="CARREGAMENTO INCORRETO">CARREGAMENTO INCORRETO</option>
<option value="SEM ESPAÇO NA CAMARA">SEM ESPAÇO NA CAMARA</option>
<option value="INADIMPLENCIA">INADIMPLENCIA</option>
<option value="SINISTRO">SINISTRO</option>
<option value="FALTA DE CAMINHÃO">FALTA DE CAMINHÃO</option>
<option value="DOCUMENTAÇÃO">DOCUMENTAÇÃO</option>
<option value="CUSTOS COM CABOTAGEM">CUSTOS COM CABOTAGEM</option>
<option value="PREÇO INCORRETO">PREÇO INCORRETO</option>
...
<option value="MÁ QUALIDADE DO PRODUTO">MÁ QUALIDADE DO PRODUTO</option>
<option value="NÃO PERMITIDO TRAFEGO DE CAMINHÕES">NÃO PERMITIDO TRAFEGO DE CAMINHÕES</option>
<option value="TEMPERATURA FORA DE PADRÃO">TEMPERATURA FORA DE PADRÃO</option>
<option value="ENTREGA FORA DE ROTA">ENTREGA FORA DE ROTA</option>
<option value="DATA DE VALIDADE COMPROMETIDA">DATA DE VALIDADE COMPROMETIDA</option>
<option value="INVERSÃO">INVERSÃO</option>
<option value="QUEBRA DE PESO">QUEBRA DE PESO</option>
<option value="COMPLEMENTO DE FRETE">COMPLEMENTO DE FRETE</option>
<option value="PRORROGAÇÃO DE TITULO">PRORROGAÇÃO DE TITULO</option>
<option value="BONIFICAÇÃO COMERCIAL">BONIFICAÇÃO COMERCIAL</option>
<option value="DESPESA EXTRA">DESPESA EXTRA</option>
<option value="SOBRA NA ENTREGA">SOBRA NA ENTREGA</option>
<option value="FRETE DIVERGENTE">FRETE DIVERGENTE</option>
