...
if($string0 != "''" AND $string1 =="''" AND $string3 =="''"){
    ...
    $query = "select * from rotas where login in($string0) and representante='$representante' order by login, lista, rota, sequencia, ocorrencia";
...
if($string0 =="''" AND $string1 != "''" AND $string3 =="''"){
    ...
    $query = "select * from rotas where lista in($string1) and representante='$representante' order by login, lista, rota, sequencia, ocorrencia";
...
if($string0 =="''" AND $string1 =="''" AND $string3 != "''"){
    ...
    $query = "select * from rotas where status in($string3) and representante='$representante' order by login, lista, rota, sequencia, ocorrencia";
...
if($string0 != "''" AND $string1 != "''" AND $string3 =="''"){
    ...
    $query = "select * from rotas where login in($string0) AND lista in($string1) and representante='$representante' order by login, lista, rota, sequencia, ocorrencia";
...
if($string0 == "''" AND $string1 != "''" AND $string3 !="''"){
    ...
    $query = "select * from rotas where lista in($string1) AND status in($string3) and representante='$representante' order by login, lista, rota, sequencia, ocorrencia";
...
if($string0 != "''" AND $string1 == "''" AND $string3 !="''"){
    ...
    $query = "select * from rotas where login in($string0) AND status in($string3) and representante='$representante' order by login, lista, rota, sequencia, ocorrencia";
 //   echo "entrou lista, ocorrencia";
}
...
if($string0 != "''" AND $string1 != "''" AND $string3 !="''"){
    ...
    $query = "select * from rotas where login in($string0) AND lista in($string1) AND status in($string3) and representante='$representante' order by login, lista, rota, sequencia, ocorrencia";
...
if($string0 =="''" AND $string1 =="''" AND $string3 =="''" ){
    ...
    $query = "select * from rotas where statusrota=1  and representante='$representante' order by login, lista, rota, sequencia, ocorrencia";
...
$html .= '<td  colspan="19" bgcolor="#c9c9c9"><strong style="font-size:17px;">' . "DATA " . date("d m Y") . " - " . "<b>" . $representante . "</b>" . '</strong></td>';
$html .= '</tr>';	
$html .= '<tr >';
$html .= '<td nowrap bgcolor="#ECECEC"><b>PLACA</b></td>';
$html .= '<td nowrap bgcolor="#ECECEC"><b>TRANSP.</b></td>';
$html .= '<td nowrap bgcolor="#ECECEC"><b>ROTA</b></td>';
$html .= '<td nowrap bgcolor="#ECECEC"><b>SEQ</b></td>';
$html .= '<td nowrap bgcolor="#ECECEC"><b>STATUS</b></td>';
...
$html .= '<td nowrap bgcolor="#ECECEC"><b>DATA DA VISITA</b></td>';
...
$html .= '<td nowrap bgcolor="#ECECEC"><b>TEMPO REAL</b></td>';
$html .= '<td nowrap bgcolor="#ECECEC"><b>RAIO</b></td>';
$html .= '<td nowrap bgcolor="#ECECEC"><b>NR_NF</b></td>';
$html .= '<td nowrap bgcolor="#ECECEC"><b>MOTORISTA</b></td>';
$html .= '<td nowrap bgcolor="#ECECEC"><b>TEL. MOTORISTA</b></td>';
$html .= '</tr>';
...
$html .= '<td nowrap>' . $transp . '</td>';
$html .= '<td nowrap>' . $rota . '</td>';
$html .= '<td nowrap>' . $sequencia . '</td>';
$html .= '<td nowrap>' . $status_ok . '</td>';
...
$html .= '<td nowrap>' . $data_visita . '</td>';
$html .= '<td nowrap>' . $ocorrencia . '</td>';
$html .= '<td nowrap>' . $subnatureza . '</td>';
$html .= '<td nowrap>' . $tempo_est . '</td>';
$html .= '<td nowrap> ' . $tempo_real . '</td>';
$html .= '<td nowrap>' . $raio . '</td>';
$html .= '<td nowrap>' . $nr_nf . '</td>';
$html .= '<td nowrap>' . $motorista . '</td>';
$html .= '<td nowrap>' . $tel_motorista . '</td>';
$html .= '</tr>';
