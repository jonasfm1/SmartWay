...
function directionResults(result, status) {
        ...
        if (status == google.maps.DirectionsStatus.OK) {
            ...
            document.getElementById('div16').innerHTML += '<table width="100%" height="40px;" border="0" cellpadding="0" cellspacing="0" class="div_nova2_tabela"><tbody><tr><td width="50%;" align="center"><img src=' + "'" + junta_veiculo[i].veiculo + "'" +  "width='30' height='28' /></td><td width='50%'>Pedidos: " + "<font size='4px'><b>" + orders.length + "</b></font></td></tr></tbody></table>";
        ...
        document.getElementById(vistitaae).innerHTML += "<br>";
             ...
             // alert(meu_distancia[i]);
						//	alert(meu_tempo[i]);
							...
							var n = ww.toString();	
              document.getElementById(vistitaae).innerHTML += "<p>&nbsp;&nbsp;&nbsp;&nbsp;" + 	pontos(meu_array[i][w], 36) + " - <strong>" + result.routes[0].legs[w].distance.text + "</strong></p>";	
