 ...
 ///////////////////////////////////////////////////////////	
 	...
 	//alert(JSON.stringify(array_segura_lista_clientes, null, 4));
			...
			//	maismais = i + 1;
				...
				document.getElementById('div16').innerHTML += '<table width="100%" height="40px;" border="0" cellpadding="0" cellspacing="0" class="div_nova2_tabela"><tbody><tr><td width="50%;" align="center"><img src=' + "'" + junta_veiculo[i].veiculo + "'" +  "width='30' height='28' /></td><td width='50%'>Pedidos: " + "<font size='4px'><b>" + data3.length + "</b></font></td></tr></tbody></table>";
