...
(function ($, window, document, undefined) {
    ...
    var pluginName = "multiselect",
        defaults = {
            ...
            searchBoxText: 'Pesquisar por nome..',
...
<body>
	...
	<div class="container" id="container" name="container">
        <form name="search_form" method="POST" action="resultado.php">
            <select name="lang0pt[]" multiple id="lang0pt">
                <?php
                  
                    $result = mysql_query("select * from usuario where nivel!=1 order by login");
            ...
            <select name="lang0pt1[]" multiple id="lang0pt1">
                <?php
            ...
            <select name="lang0pt2[]" multiple id="lang0pt2">
                <?php
                  
                    $result2 = mysql_query("select DISTINCT rota from rotas order by id DESC");
                    while ($rowsec2 = mysql_fetch_assoc($result2)){
                        echo("<option value='$rowsec2[rota]'>$rowsec2[rota]</option>");
                    }
                ?>
            </select>
            <script>
                $('#lang0pt2').multiselect({
                    columns: 1,
