...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#579bd3; font-size: 11px; color: white" >
    <tr>
		<td align="left" valign="center" colspan="3" height="50px"><i class="material-icons" style="font-size:22px; vertical-align:bottom;padding-left: 15px;">edit_location_alt</i><strong><font size="2px">&nbsp;LOCALIZAR CLIENTE - <?php echo $_reg; ?></font></strong>  
      </td>
    </tr>
</table>
<br>
     ...
     <tr >
      <td height="50px" style="color: #000000; padding-left:20px; font-size:14px; font-weight:bold ">
   <input id="geocomplete" name="geocomplete" type="text" placeholder="Procure o endereço" size="100%" style="height:25px; padding-left:6px; width:100%;" value="<?php echo $_endereco . ', ' . $_cidade . ', CEP: ' .   $_cep1;?>"/> </td>
   <td colspan="2" style="text-align:right"><div id="apDiv7x"><input id="find" type="button" value="PROCURAR" onClick="MostraDiv();" /></div>
    ...
    <tr>
      <td colspan="2" height="240;" style=" background-color:#FFFFFF;"><div id="map_canvas" class="map_canvas" style="width: 100%; height: 100%; margin: 0 0 0 0; visibility:hidden"></div></td>
    </tr>
 ...
 <tr style="background-color:#FFF; height:70px" hidden>
      ...
      <input type="hidden" name="cidade" id="cidade" value="<?php echo $_cidade;  ?>"/>
      <input type="hidden" name="uf" id="uf" value="<?php echo $_uf;  ?>"/>
      <input type="hidden" name="cep" id="cep" value="<?php echo $_cep1;  ?>"/>
     
      <input type="hidden" name="nome" id="nome" value="<?php echo $_nome_cli;  ?>"/>

      <input type="hidden" name="bairro" id="bairro" value="<?php echo $_bairro;  ?>"/>
      </td>
    </tr>
