...
$query_confere = "select formacao from importa where formacao='$formacao' and cnpj='$cnpj'";												
...
if($registros!=0){
   ...
   $lista_atualizada = "LISTA-" . $today1 . " (ATUALIZADA)";
...
///////////////////////////
 ...
 $querylista = mysql_query("UPDATE listas SET nome='$lista_final_update' where nome='$lista_final'");
//////////////////////////
