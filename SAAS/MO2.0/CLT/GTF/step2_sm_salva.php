...
/* On mouse-over, add a grey background color */dcx vsd t cbcc r
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#579bd3; font-size: 11px; color: white" >
    <tr>
		<td align="left" valign="center" colspan="3" height="50px"><i class="material-icons" style="font-size:22px; vertical-align:bottom;padding-left: 15px;">save</i><strong><font size="2px">&nbsp;SALVAR NOVA ORDEM DAS COLUNAS DA TABELA</strong>  
      </td>
    </tr>
</table>
</div>
 <div id="total">
      ...
      <form action="scripts.php?acao=salva_ordem_table" method="POST" name="envia" id="envia">
		 <?php
      $ordem = $_GET['table_ordem'];


      $pieces = explode(",", $ordem);
...
<td align="center" width="100%">
	...
	<label class="container"><i class="material-icons" style="font-size:24px; vertical-align:middle; color: grey; align-content: center; padding-right: 3px; padding-left: 10px">reorder</i>

	
	<span style="vertical-align:inherit"><?php echo  strtoupper($pieces[$i2]);?></span>
...
?>
      ...
      <input type="text" id="table_ordem" name="table_ordem" size="50" value="<?php echo $ordem ?>" hidden="hidden">

</div>

<div id="total3">

<input type="submit" value="SALVAR" id="calculo" />
