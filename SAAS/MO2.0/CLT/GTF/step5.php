...
<font size="2" style="text-align: left"><strong>LOGIN</strong></font>
  ...
  <?php 
	$query3 = "select login from usuario where nivel=2 order by login";			
...
<select name="id_lista" style="width:100%">
        ...
        <?php 
    $query_lista = "select rotas.lista, usuario.coordenador from rotas INNER JOIN usuario ON usuario.login=rotas.login GROUP BY rotas.lista order by rotas.id DESC";											
...
<select name="id_rota" style="width:100%">
        ...
        <?php 
    $query3 = "select rotas.rota, usuario.coordenador, rotas.login from rotas INNER JOIN usuario ON usuario.login=rotas.login where rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' GROUP BY rotas.rota order by rotas.statusrota, rotas.rota ASC";															
    $rs3 = mysql_query($query3);									
    while($row3 = mysql_fetch_array($rs3)){
    $id_rota = $row3["rota"];
    ?>
...
$query_pizza_todos = "select rotas.*, usuario.coordenador, usuario.login from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'";														
$rs_pizza_todos = mysql_query($query_pizza_todos);
$num_rows_pizza_todos = mysql_num_rows($rs_pizza_todos);


$query_pizza1 = "select rotas.*, usuario.coordenador, usuario.login from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.status=1 AND rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'";													
...
$query_pizza2 = "select rotas.*, usuario.coordenador, usuario.login from rotas INNER JOIN usuario ON rotas.login=usuario.login where  rotas.status=2 AND rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'";															
...
$query_pizza3 = "select rotas.*, usuario.coordenador, usuario.login from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.status=0 AND rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'";															
...
$query_pizza4 = "select rotas.*, usuario.coordenador, usuario.login from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.status=3 AND rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'";														
...
///NEGATIVOS TODOS
$query_negativos_todos =  mysql_query("select rotas.*, usuario.coordenador, usuario.login from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.status=2 AND rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'");															
...
$query_negativos =  mysql_query("select rotas.*, usuario.coordenador, usuario.login from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.ocorrencia='$titulos_id' AND rotas.status=2 AND rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'");															
...
///POSITIVOS TODOS
$query_positivos_todos =  mysql_query("select rotas.*, usuario.coordenador, usuario.login from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.status=1 AND rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'");															
...
$query_positivos =  mysql_query("select rotas.*, usuario.coordenador, usuario.login from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.ocorrencia='$titulos1_id' AND rotas.status=1 AND rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'");															
...
///ALERTAS TODOS
$query_alertas_todos =  mysql_query("select rotas.*, usuario.coordenador, usuario.login from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.status=3 AND rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'");															
...
$query_alertas =  mysql_query("select rotas.*, usuario.coordenador, usuario.login from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.ocorrencia='$titulos2_id' AND rotas.status=3 AND rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'");														
...
$query_dataformata =  mysql_query("select Max(rotas.id) AS id, DATE_FORMAT(rotas.dth_ocorrencia,'%y-%m-%d') AS data, COUNT(rotas.dth_ocorrencia) AS qto_visitas from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota' AND rotas.dth_ocorrencia!='0000-00-00 00:00:00' group by data order by data ASC");	
...
$query_todos =  mysql_query("select rotas.* from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'");															
$num_rows_todos = mysql_num_rows($query_todos);

$query_pendentes =  mysql_query("select rotas.* from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.status=0 AND rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'");															
...
$query_realizados =  mysql_query("select rotas.* from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.status!=0 AND rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'");															
...
///
$query_todos1 =  mysql_query("select rotas.* from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.login LIKE '$pega_login' AND  rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'");															
$num_rows_todos1 = mysql_num_rows($query_todos1);

$query_pendentes1 =  mysql_query("select rotas.* from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.status!=0 AND rotas.ce=0 AND rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'");															
$num_rows_pendentes1 = mysql_num_rows($query_pendentes1);

//$num_rows_pendentes1 = $num_rows_pendentes1/$num_rows_todos1;
...
$query_realizados1 =  mysql_query("select rotas.* from rotas INNER JOIN usuario ON rotas.login=usuario.login where rotas.status!=0 AND rotas.ce=1 AND rotas.login LIKE '$pega_login' AND rotas.lista LIKE '$pega_lista' AND rotas.rota LIKE '$pega_rota'");														
