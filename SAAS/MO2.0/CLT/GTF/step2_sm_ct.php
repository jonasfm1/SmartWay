...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#579bd3; font-size: 11px; color: white" >
    <tr>
		<td align="left" valign="center" colspan="3" height="50px"><i class="material-icons" style="font-size:22px; vertical-align:bottom;padding-left: 15px;">remove_red_eye</i><strong><font size="2px">&nbsp;CANHOTO CONFERIDO</strong>  
      </td>
    </tr>
</table>
</div>
 <div id="total">
      ...
      <form action="scripts.php?acao=altera_canhoto_site" method="POST" name="envia" id="envia" onsubmit="return verificar();">
...
<td align="center" width="100%">
	...
	<label class="container"><i class="material-icons" style="font-size:24px; vertical-align:middle; color: green; align-content: center; padding-right: 3px; padding-left: 10px">thumb_up</i>

	
	<span style="vertical-align:inherit">CONFERIDO</span>
  <input type="radio" value="1" name="RadioGroup1"  id="RadioGroup1">
...
<td align="center" width="100%">
	...
	<label class="container"><i class="material-icons" style="font-size:24px; vertical-align:middle; color: red; align-content: center; padding-right: 3px; padding-left: 10px">thumb_down</i>

	
	<span style="vertical-align:inherit">NÃO CONFERIDO</span>
