...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#579bd3; font-size: 11px; color: white" >
    <tr>
		<td align="left" valign="center" colspan="3" height="50px"><i class="material-icons" style="font-size:22px; vertical-align:bottom;padding-left: 15px;">remove_red_eye</i><strong><font size="2px">&nbsp;EXCLUIR REGISTROS</strong>  
      </td>
    </tr>
</table>
</div>
 <div id="total">
      ...
      <form action="scripts.php?acao=excluir_registro" method="POST" name="envia" id="envia">
...
<td align="center" width="100%">
	...
	<label class="container"><i class="material-icons" style="font-size:24px; vertical-align:middle; color: red; align-content: center; padding-right: 3px; padding-left: 10px">highlight_off</i>
