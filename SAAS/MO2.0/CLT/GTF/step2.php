...
function acao_chat(campo) {
  ...
  function acao_localiza_ponto(campo) {
...
function acao_imprimir() 
		{ 
            ...
            var quem = document.getElementById("repre").value;
...
var teste = "pdfs.php?exp1=" + exp1 + "&exp2=" + exp2 + "&exp3=" + exp3 + "&repre=" + quem;

//var = document.getElementById("frm");
...
if($string0!="" AND $string1=="" AND $string3==""){
    ...
    $query = "select * from rotas where login in($string0) order by id_lista, login, lista, rota, sequencia";
...
$query_pizza5 = "select SUM(peso) AS peso_pega from rotas where login in($string0)";														
$rs_pizza5 = mysql_query($query_pizza5);

$dados_peso = mysql_fetch_array($rs_pizza5);
$soma_peso = $dados_peso['peso_pega'];


$query_pizza5x = "select SUM(peso) AS peso_pegax from rotas where status!=1 AND login in($string0)";												
$rs_pizza5x = mysql_query($query_pizza5x);

$dados_pesox = mysql_fetch_array($rs_pizza5x);
$soma_pesox = $dados_pesox['peso_pegax'];


$sobra_peso = $soma_peso - $soma_pesox;
   
    
if ($soma_pesox==null){

    $sobra_peso = $soma_peso;
    $soma_pesox =0;
...
$query_pizza5 = "select SUM(peso) AS peso_pega from rotas where id_lista in($string1)";														
$rs_pizza5 = mysql_query($query_pizza5);
...
$query_pizza5x = "select SUM(peso) AS peso_pegax from rotas where status!=1 AND id_lista in($string1)";												
$rs_pizza5x = mysql_query($query_pizza5x);
...
$query = "select * from rotas where status in($string3) order by id_lista, login, lista, rota, sequencia";
...
$query_pizza5 = "select SUM(peso) AS peso_pega from rotas where status in($string3)";														
$rs_pizza5 = mysql_query($query_pizza5);
...
$query_pizza5x = "select SUM(peso) AS peso_pegax from rotas where status!=1 AND status in($string3)";												
$rs_pizza5x = mysql_query($query_pizza5x);
...
if($string0!="" AND $string1!="" AND $string3==""){
    ...
    $query = "select * from rotas where login in($string0) AND id_lista in($string1) order by id_lista, login, lista, rota, sequencia";
    ...
    $query_pizza5 = "select SUM(peso) AS peso_pega from rotas where login in($string0) AND id_lista in($string1)";														
    $rs_pizza5 = mysql_query($query_pizza5);
    ...
    $query_pizza5x = "select SUM(peso) AS peso_pegax from rotas where status!=1 AND login in($string0) AND id_lista in($string1)";												
    $rs_pizza5x = mysql_query($query_pizza5x);
...
if($string0!="" AND $string1=="" AND $string3!=""){
    ...
    $query = "select * from rotas where login in($string0) AND status in($string3) order by id_lista, login, lista, rota, sequencia";
    ...
    $query_pizza5 = "select SUM(peso) AS peso_pega from rotas where login in($string0) AND status in($string3)";														
    $rs_pizza5 = mysql_query($query_pizza5);
    ...
    $query_pizza5x = "select SUM(peso) AS peso_pegax from rotas where status!=1 AND login in($string0) AND status in($string3)";												
    $rs_pizza5x = mysql_query($query_pizza5x);
...
if($string0=="" AND $string1!="" AND $string3!=""){
    ...
    $query = "select * from rotas where id_lista in($string1) AND status in($string3) order by id_lista, login, lista, rota, sequencia";
    ...
    $query_pizza5 = "select SUM(peso) AS peso_pega from rotas where id_lista in($string1) AND status in($string3)";														
    $rs_pizza5 = mysql_query($query_pizza5);
    ...
    $query_pizza5x = "select SUM(peso) AS peso_pegax from rotas where status!=1 AND id_lista in($string1) AND status in($string3)";														
    $rs_pizza5x = mysql_query($query_pizza5x);
...
$query = "select * from rotas where login in($string0) AND id_lista in($string1) AND status in($string3) order by id_lista, login, lista, rota, sequencia";
...
$query_pizza5 = "select SUM(peso) AS peso_pega from rotas  where login in($string0) AND id_lista in($string1) AND status in($string3)";														
$rs_pizza5 = mysql_query($query_pizza5);
...
$query_pizza5x = "select SUM(peso) AS peso_pegax from rotas where status!=1 and login in($string0) AND id_lista in($string1) AND status in($string3)";														
$rs_pizza5x = mysql_query($query_pizza5x);
...
if($string0=="" AND $string1=="" AND $string3==""){
    ...
    $aviso_listatual = " &#x2022; LISTAS ATIVAS";

    
    $query = "select * from rotas where statusrota=1 order by id_lista, login, lista, rota, sequencia";
    ...
    $query_pizza5 = "select SUM(peso) AS peso_pega from rotas where statusrota=1";														
    $rs_pizza5 = mysql_query($query_pizza5);
    ...
    $query_pizza5x = "select SUM(peso) AS peso_pegax from rotas where status!=1 and statusrota=1";														
    $rs_pizza5x = mysql_query($query_pizza5x);
...
<font size="2" style="text-align: left">&nbsp;&nbsp;ALTERAR OCORRÊNCIA</font>
   ...
   <font size="2"  style="text-align: left">&nbsp;&nbsp;ALTERAR LOGIN</font>
	...
	<td  nowrap="nowrap" style="width: 15px">
			...
			<i class="material-icons" style="font-size:24px; vertical-align:bottom">schedule</i>
		
    </td>
    <td nowrap="nowrap">
    <a href="javascript:acao9();">
    <font size="2">&nbsp;&nbsp;ADICIONAR TEMPO DE VISITA</font>
    </a>
    </td>
    </tr>
    <tr>
	<td  nowrap="nowrap" style="width: 15px">
			...
			<i class="material-icons" style="font-size:24px; vertical-align:bottom">add_box</i>
		
    </td>
    <td nowrap="nowrap">
    <a href="javascript:acao10();">
    <font size="2">&nbsp;&nbsp;ADICIONAR SUB-NATUREZA</font>
    </a>
    </td>
    </tr>
		</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" style="padding-top: 25px; padding-bottom: 8px; width:360px" >
    ...
    <tr>
                ...
                <td nowrap="nowrap" style="height: 40px;">
                  ...
                  <font size="2"><strong>&nbsp;&nbsp;EXPORTAR POR REPRESENTANTE</strong></font>
             
                </td>
   
     
    </tr>
    <form action="export_repre.php?acao=export_xls" method="post" id='ok'>
    <tr>
...
if($string1==""){
    ...
    $completax1 = " AND id_lista in($string1) ";
}
...
$query_repre = "select * from rotas where sequencia!=''" . $completax0 . $completax1 . $completax3 . " group by representante";
$rs_repre = mysql_query($query_repre);
$total = mysql_num_rows($rs_repre);
$conta_ae=0;
while($rowx = mysql_fetch_array($rs_repre)){
    $conta_ae++;

?>
<option value="<?php echo $rowx['representante']; ?>"><?php echo $rowx['representante']; ?></option>

<?php

if($conta_ae==$total){
    $guarda_repre = $guarda_repre . $rowx['representante'];
} else {
    $guarda_repre = $guarda_repre . $rowx['representante'] . ";";
}
...
<input type="text"  value="<?php echo "'" .implode("','", $campo3) . "'"; ?>" name="exp3" id="exp3" hidden="hidden"  />
    ...
    <td colspan="2" >
            ...
            <input type="submit" name="submit" value="EXPORTAR" style="width: 153px; margin-left:0" />   </form>
         
            <input type="submit" name="submit" value="ZIP" onClick="acao_imprimir();return false;" style="width: 153px;" />
            <input type="text" value="<?php print_r($guarda_repre) ; ?>" name="repre[]" id="repre" hidden>
		</td> 
...
<font size="2" style="text-align: left">&nbsp;&nbsp;IMPRIMIR PDF</font></b>
</a>
    </td>
    </tr>
    <tr>
    ...
    <form action="export_todos.php?acao=export_xls" method="post" id='myform'>
	<td nowrap="nowrap" style="width: 20px">
...
//            echo $pega_ocorrencia;
      ...
      array_push($peso_liquido, $row["peso_liquido_item"]);
...
if($pieces[$i1]=="status"){
?>
<td align="center" style="width: 20px"><i class="material-icons" style="font-size:14px; color: <?php echo $status_icon;?>">circle</i>
...
if($pieces[$i1]=="geo"){
  ...
  $guarda = "h=" . $row["x"] . "&v=" . $row["y"] . "&reg=" . $row["idcliente"] . "&endereco=" . $row["endereco"] . "&codigo=" . $row["id"] . "&nome=" . $row["nome"] . "&cidade=" . $row["cidade"] . "&uf=" . $row["uf"] . "&cep=" . $row["cep"] . "&bairro=" . $row["bairro"];


    if($row["y"]=='-15.793841' and $row["x"] == '-47.875806'){
?>
  <td align="center" nowrap="nowrap" width="auto" style="background-color: #F80004;"><a href="javascript:acao_localiza_ponto('<?php echo $guarda;?>');" data-tooltip="Localização do Cliente"><i class="material-icons" style="font-size:14px; color:#FFF">location_on</i></a></td>
     
<?php
    } else {
?>
  <td align="center" nowrap="nowrap" width="auto"><a href="javascript:acao_localiza_ponto('<?php echo $guarda;?>');" data-tooltip="Localização do Cliente"><i class="material-icons" style="font-size:14px">location_on</i></a></td>
...
if($total!=0){
?>
<a href="javascript:acao_volta(<?php echo "'" . "?id=" . $row["id"] . "'"; ?>);"><i class="material-icons" style="font-size:14px">&#xe3b0;</i></a>
<?php   
} 
?>
</td>      
...
if($pieces[$i1]=="edit"){
    ?>
<td align="center" style="width: 20px"><a href="#" data-tooltip="Editar dados do cliente" onclick="javascript:alert('Icone temporariamente desabilitado!');return false;"><i class="material-icons" style="font-size:14px">&#xe560;</i></a></td>  
    <?php
        } 

if($pieces[$i1]=="exclui"){
    ?>  
  <td align="center" style="width: 20px"><a href="javascript:confirmaExclusao('scripts.php?acao=exclui_cliente_base_cliente&id=<?php echo $row["id"] ?>')" data-tooltip="Excluir cliente"><i class="material-icons" style="font-size:14px;color:red">&#xe5c9;</i></a></td>       
    <?php
        } 
        if($pieces[$i1]=="localiza"){
            ?> 
            <td align="center" style="width: 20px">
            <a href="javascript:map.setCenter(new google.maps.LatLng(<?php echo $row["y"]; ?>,<?php echo $row["x"]; ?>));map.setZoom(12);infobox(<?php echo $row["y"]; ?>, <?php echo $row["x"]; ?>, '<?php echo mb_strimwidth($row["nome"], 0, 60, "..."); ?>');"><i class="material-icons" style="font-size:14px;color:black">my_location</i></a>
          </td>  
           <?php
                } 
...
if($row["tempo_est"]==""){
    ...
    echo $row["tempo_est"];
?>
<a href="scripts.php?acao=atualiza_tempo&id=<?php echo $row['id'];?>&temp_est=<?php echo $row['tempo_est'];?>">
<i class='material-icons' style='font-size:14px;color: black;vertical-align: bottom;'>sync</i>
</a>
<?php
}
...
if($pieces[$i1]!="tempo_est" AND $pieces[$i1]!="pedido" AND $pieces[$i1]!="nr_nf" AND $pieces[$i1]!="check" AND $pieces[$i1]!="status" AND $pieces[$i1]!="geo" AND $pieces[$i1]!="foto" AND $pieces[$i1]!="edit" AND $pieces[$i1]!="exclui" AND $pieces[$i1]!="localiza" AND $pieces[$i1]!="codigo_pedido" AND $pieces[$i1]!="ocorrencia" AND $pieces[$i1]!="tempo" AND $pieces[$i1]!="ce" AND $pieces[$i1]!="p.o" AND $pieces[$i1]!="canhoto"){
?>
...
$query_usuarios = "SELECT * FROM rastro r1 INNER JOIN usuario ON usuario.login = r1.login WHERE r1.id = (SELECT max(r2.id) FROM rastro r2 WHERE r2.login = r1.login) AND usuario.nivel>0";

//$query_usuarios = "SELECT * FROM rastro where login in($string0) ORDER BY id DESC";


//$query_usuarios = "SELECT * FROM rastro"SELECT r1.id, r1.x, r1.y, r1.dth, r1.login, r1.day, usuario.coordenador, usuario.login FROM rastro r1 INNER JOIN usuario ON usuario.login = r1.login WHERE r1.id = (SELECT max(r2.id) FROM rastro r2 WHERE r2.login = r1.login) AND usuario.nivel>0";

$rs_usuarios = mysql_query($query_usuarios);
...
$usuario_x_usr[]=null;
$data_usr[]=null; 
$data_formatada_usr[]=null;
$hora_usr[]=null;

//////////////////////////////////
while($row_usr = mysql_fetch_array($rs_usuarios)){
    $lat_cad_usr[$i_usr] = $row_usr["y"];
    $lng_cad_usr[$i_usr] = $row_usr["x"];
    $data_usr[$i_usr] = $row_usr["day"];
    $hora_usr[$i_usr] = $row_usr["dth"];
    $timestamp_usr = strtotime($row_usr["day"]);
    $data_formatada_usr[$i_usr] = date('d/m/Y', $timestamp_usr);
    $usuario_x_usr[$i_usr] = $row_usr["login"];
    $login_usr[$i_usr] = strtoupper($row_usr["login"]);	
...
?>
 ...
 while($i_usr > 0){
	  ?>['<?php echo $login_usr[$i_usr]?>',<?php echo $lat_cad_usr[$i_usr]?>,<?php echo $lng_cad_usr[$i_usr]?>,<?php echo $i_usr?>,'<?php echo $usuario_x_usr[$i_usr]?>','<?php echo $data_formatada_usr[$i_usr]?>','<?php echo $hora_usr[$i_usr]?>'], 
	   <?php $i_usr--; ?>
	   <?php }?>
      ['<?php echo $login_usr[$i_usr]?>',<?php echo $lat_cad_usr[$i_usr]?>,<?php echo $lng_cad_usr[$i_usr]?>,<?php echo $i_usr?>,'<?php echo $usuario_x_usr[$i_usr]?>','<?php echo $data_formatada_usr[$i_usr]?>','<?php echo $hora_usr[$i_usr]?>']
    ];
...
function initMap() {
     ...
     //alert(locations_usr[0][2]);

     //alert(locations_usr.length);
//VEICULOS///////
if(locations_usr.length==0){

} else {

for (i_x = 0; i_x < locations_usr.length; i_x++) {

var time1 = locations_usr[i_x][5] + ' ' + locations_usr[i_x][6];
...
var diff = moment(time2,"DD/MM/YYYY HH:mm:ss").diff(moment(time1,"DD/MM/YYYY HH:mm:ss"));
...
//alert(locations_usr[i_x][0]); // 105



        var locate = new google.maps.LatLng(parseFloat(locations_usr[i_x][1]), parseFloat(locations_usr[i_x][2])); 
        marker_veiculo = new MarkerWithLabel({
        position: locate,
        map: map,
        optimized: true,
        clickable: true,	
        icon: icon,	    
        labelContent: locations_usr[i_x][0],
...
<tr>
    ...
    <div id="categoria1x">
     <div id="cat_text">Total Kg</div>    
     <div id="cat1x"><?php echo number_format((float)$soma_peso, 3, '.', ''); ?></div>
     </div>
    </td>
    <td  align="left" nowrap="nowrap" style="width: 12%">
    <div id="categoria2x">
     <div id="cat_text1">Kg Pendentes</div>
     <div id="cat2x"><?php echo number_format((float)$soma_pesox, 3, '.', ''); ?></div>
     </div>
...
<script type="text/javascript">
      ...
      function drawChart() {
		var data = google.visualization.arrayToDataTable([
          ['CATEGORIA', 'RESULTADO'],
          ['PENDENTE', <?php echo $soma_pesox;?>],
          ['ENTREGUE', <?php echo $sobra_peso;?>],
...
<div id="geo" style="display: none;">
      ...
      <div id="botao_geo"><a href="javascript:void(0); " onclick="window.location.reload();" ><i class="material-icons" style="font-size:30px;color:black;">&#xe5c9;</i></a></div>
