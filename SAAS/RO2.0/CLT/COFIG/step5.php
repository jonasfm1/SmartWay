...
<tr>
    ...
    <a href="scripts.php?acao=integracao_erp" >
    <font style="text-align: center">&nbsp;&nbsp;BAIXA DOS ROMANEIOS</font>
    </a>
    </td>
    </tr>
...
<tr>
	<td nowrap="nowrap" style="width: 20px">
	<i class="material-icons" style="font-size:22px; vertical-align:bottom">app_settings_alt</i>
    </td>
    <td nowrap="nowrap">
  <form action="scripts.php?acao=importar_monitoramento" method="post" name="myForm" id="myform" >
    <a href="#" onclick="document.getElementById('myform').submit();" name="link_mo">
    <font style="text-align: center">&nbsp;&nbsp;IMPORTAR MONITORAMENTO</font>
    </a>
...
<td>
  ...
  <input type="text" class="form-control" name="data" value="<?php echo date('d-m-y', strtotime('+1 days')) ?>" style="width: 170px;height: 25px; font-size:11px;font-weight: bold;" >
       <span class="input-group-addon" >
         <span class="glyphicon glyphicon-th" style="height: 10px;font-size:11px;"></span>
       </span>
     </div>
