...
if ($pega_listagem == "red" or $pega_listagem == "") {
  ...
  if($pega_escolha==""){   
    $query = "select codigo, confianca_cad, endereco_cad, codigo_cliente, nome, endereco, bairro, cidade, estado, cep, SUM(peso) AS peso, SUM(volume) AS volume,  SUM(valor) AS valor, obs_pedido, premium, cnpj_redespacho, dt_emissao from clientes where confianca_cad<=50 AND roteirizado!='sim' AND ativo=0 group by codigo_cliente";
...
if ($pega_listagem == "orange") {
  ...
  if($pega_escolha==""){   
    $query = "select codigo, confianca_cad, endereco_cad, codigo_cliente, nome, endereco, bairro, cidade, estado, cep, SUM(peso) AS peso, SUM(volume) AS volume,  SUM(valor) AS valor, obs_pedido, premium, cnpj_redespacho, dt_emissao from clientes where confianca_cad>50 AND confianca_cad<=70 AND roteirizado!='sim' and ativo=0 group by codigo_cliente";
...
if ($pega_listagem == "green") {
  ...
  if($pega_escolha==""){   
    $query = "select codigo, confianca_cad, endereco_cad, codigo_cliente, nome, endereco, bairro, cidade, estado, cep, SUM(peso) AS peso, SUM(volume) AS volume,  SUM(valor) AS valor, obs_pedido, premium, cnpj_redespacho, dt_emissao from clientes where confianca_cad>70 AND confianca_cad<=100 AND roteirizado!='sim' and ativo=0 group by codigo_cliente";
...
if ($pega_listagem == "blue") {
  ...
  if($pega_escolha==""){   
    $query = "select codigo, confianca_cad, endereco_cad, codigo_cliente, nome, endereco, bairro, cidade, estado, cep, SUM(peso) AS peso, SUM(volume) AS volume,  SUM(valor) AS valor, obs_pedido, premium, cnpj_redespacho, dt_emissao from clientes where confianca_cad=101 AND roteirizado!='sim' and ativo=0 group by codigo_cliente";
    } else {
...
if ($pega_listagem == "roxo") {
  ...
  if($pega_escolha==""){   
  $query = "select codigo, confianca_cad, endereco_cad, codigo_cliente, nome, endereco, bairro, cidade, estado, cep, SUM(peso) AS peso, SUM(volume) AS volume,  SUM(valor) AS valor, obs_pedido, premium, cnpj_redespacho, dt_emissao from clientes where roteirizado!='sim' and ativo=1 group by codigo_cliente";
  } else {
...
<th nowrap="nowrap" headers="icone" bgcolor="#00000"  style="color:#000000; width:10px"  class="drag-enable" title="RDP">
<div align="center" >RDP</div>
</th>
<th nowrap="nowrap" headers="icone" bgcolor="#00000" style="color:#000000;"class="drag-enable" title="DATA EMISSÃO">
<div align="center" >DT. EMISSÃO</div>
</th>
...
while ($row = mysql_fetch_array($rs)) {
  ...
  $redespacho = $row["cnpj_redespacho"];
...
echo "<i class='material-icons' style='font-size:16px;color: green;'>home</i>";
echo $redespacho;
} else {
  
  echo "<i class='material-icons' style='font-size:16px;color: red;'>local_shipping</i>";

}
  ?>
</td>	
<td align="center"><div align="center"><?php echo $dt_emissao;?></div></td>
<td  align="center"  nowrap="nowrap">
  <?php
if ($redespacho==""){
echo $row["nome"];
} else {
  echo "<strong><p style='color:red;'>" . $row["nome"] . "</p></strong>";
