...
<br>
 <table width="100%" border="1" class="bordasimples" cellpadding="2" cellspacing="2">
    ...
    <tr style="text-transform:uppercase;font-weight: bold;color: #000000;" bgcolor="#ECECEC">
      ...
      <td  height="20" nowrap style="padding-top: 15px; padding-left:5px">Motorista</td>
      <td  height="20" nowrap style="padding-top: 15px; padding-left:5px">Tipo</td>
      <td  nowrap style="padding-top: 15px; padding-left:5px">NOTAS</td>
      <td   nowrap style="padding-top: 15px; padding-left:5px">REMETENTE</td>
      ...
      <td   nowrap style="padding-top: 15px; padding-left:5px">REDESPACHO</td>
      <td   nowrap style="padding-top: 15px; padding-left:5px">END. REDESPACHO</td>
      <td   nowrap style="padding-top: 15px; padding-left:5px">CID. REDESPACHO</td>
      <td   nowrap style="padding-top: 15px; padding-left:5px">UF. REDESPACHO</td>


      <td  nowrap style="padding-top: 15px; padding-left:5px">Peso</td>
      <td nowrap style="padding-top: 15px; padding-left:5px">Volume</td>
      <td   nowrap style="padding-top: 15px; padding-left:5px">Valor</td>
...
//	$veiculo1=[];
    ...
    $motorista =  $row1["motorista"];	
    $tipo =  $row1["tipo_veiculo"];	
    $remetente =  $row1["remetente"];	

    $redespacho =  $row1["redespacho"];	
    $end_redespacho_ =  $row1["endereco_redespacho"];	
    $cid_remetente =  $row1["cidade_redespacho"];	
    $uf_remetente =  $row1["uf_redespacho"];	
...
?>
      ...
      <td  style="padding-left: 5px;"><?php echo $motorista ?></td>
      <td  style="padding-left: 5px;"><?php echo $tipo ?></td>
      <td  style="padding-left: 5px;"><?php echo $codigo_pedido ?></td>
      <td  style="padding-left: 5px;"><?php echo $remetente ?></td>
      ...
      <td   style="padding-left: 5px;" ><?php echo $cidade ?></td>
       ...
       <td  style="padding-left: 5px;" ><?php echo $redespacho ?></td>
       <td  style="padding-left: 5px;" ><?php echo $end_redespacho_ ?></td>
       <td  style="padding-left: 5px;" ><?php echo $cid_remetente ?></td>
       <td  style="padding-left: 5px;" ><?php echo $uf_remetente ?></td>
       
      <td  style="padding-left: 5px;"><?php echo $peso ?></td>
      <td  style="padding-left: 5px;"><?php echo $volume ?></td>
      <td  style="padding-left: 5px;" ><?php echo $valor ?></td>
