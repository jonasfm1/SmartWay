...
<td align="left"  nowrap="nowrap"><?php echo $row["nome_rota"];?></td>
...
<td align="left" nowrap="nowrap" title="<?php echo $row["remetente"];?>"><?= mb_strimwidth($row["remetente"], 0, 20, "...");?></td>


<td align="left" nowrap="nowrap"><?php echo $row["codigo_cliente"];?></td>
	
<td align="left" nowrap="nowrap" title="<?php echo $row["nome_cliente"];?>"><?= mb_strimwidth($row["nome_cliente"], 0, 20, "...");?></td>
<td align="left" nowrap="nowrap" title="<?php echo $row["endereco"];?>"><?= mb_strimwidth($row["endereco"], 0, 20, "...");?></td>
<td align="left" nowrap="nowrap" title="<?php echo $row["bairro"];?>"><?= mb_strimwidth($row["bairro"], 0, 20, "...");?></td>
<td align="left" nowrap="nowrap" title="<?php echo $row["cidade"];?>"><?= mb_strimwidth($row["cidade"], 0, 20, "...");?></td>
...
<td align="left" nowrap="nowrap" title="<?php echo $row["redespacho"];?>">
  <?= mb_strimwidth($row["redespacho"], 0, 20, "..."); ?>
 
</td>

<td align="left" nowrap="nowrap" title="<?php echo $row["endereco_redespacho"];?>">
  <?= mb_strimwidth($row["endereco_redespacho"], 0, 20, "..."); ?>
 
</td>

<td align="left" nowrap="nowrap" title="<?php echo $row["cidade_redespacho"];?>">
  <?= mb_strimwidth($row["cidade_redespacho"], 0, 20, "..."); ?>
 
</td>

<td align="left" nowrap="nowrap" title="<?php echo $row["uf_redespacho"];?>">
  <?= mb_strimwidth($row["uf_redespacho"], 0, 20, "..."); ?>
...
<tr>
    ...
    <a href="testeXlsx.php" >
    <font style="text-align: center">&nbsp;&nbsp;BAIXAR POR SEQUÊNCIA</font>
    </a>
    </td>
</tr>
    <tr>
    ...
    <a href="remontarXlsx.php" >
    <font style="text-align: center">&nbsp;&nbsp;REMONTAR</font>
    </a>
    </td>
    </tr>
        </table>
...
<td>
  ...
  <form action="#" method="get" name="myForm" id="myform">
    ...
    <a href="../../../MO2.0/index.php?l=slt_galpao@slt_galpao&s=slt_galpao" target="_blank">
