...
if ($id_cliente==$cod_cli[$conta]){
		$query_igual = "UPDATE clientes SET endereco_cad='$_igual_end_cad', latitude_cad='$_igual_latitude_cad', longitude_cad='$_igual_longitude_cad', confianca_cad='$_igual_confianca', geo_manual='$_igual_geomanual', codigo_db_geral='$codigo', endereco='$_igual_end_cad' WHERE codigo_cliente = '$cod_cli[$conta]'";
...
///ABRE /////////////////////////////////////////////////////////////////
    ...
    $query2 = "UPDATE clientes SET endereco_cad='Endereço não encontrado!', latitude_cad='-15.793841', longitude_cad='-47.875806', confianca_cad=0 WHERE codigo_cliente = '$cod_cli[$conta]'";
