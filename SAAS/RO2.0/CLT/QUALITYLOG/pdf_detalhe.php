...
<br>
 <table width="100%" border="1" class="bordasimples" cellpadding="2" cellspacing="2">
    ...
    <tr style="text-transform:uppercase;font-weight: bold;color: #000000;" bgcolor="#ECECEC">
      ...
      <td  nowrap  style="padding-top: 15px; padding-left:5px">Cod. Produto</td>
      <td  nowrap  style="padding-top: 15px; padding-left:5px">Produto</td>
...
?>
      ...
      <td   style="padding-left: 5px;" ><?php echo $cod_produto ?></td>
      <td   style="padding-left: 5px;" ><?php echo $produto ?></td>
