...
// ERRO BANCO VAZIO
$query = "select * from excluidos_industria";															
...
<div id="total">
   ...
   <tr>
       ...
       <font size="4"><strong>&nbsp;CONTROLE DEVOLUÇÃO INDÚSTRIA - </strong></font>
...
<table  border="0" cellpadding="0" cellspacing="0">
  <tbody>
    <tr style="height: 40px;">
     <form action="cad_pedidos_ex_dev.php" method="get">
...
echo "Banco de dados ainda vazio!";
 ...
 $query_novo = "select * from excluidos_industria where $_qual like '%$_palavra%' ";
