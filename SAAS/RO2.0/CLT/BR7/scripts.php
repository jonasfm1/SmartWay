...
while($row = mysql_fetch_array($rs)){	
	...
	$query2 = "UPDATE clientes SET nome='$nome_cliente', endereco='$endereco_cliente', bairro='$bairro_cliente', cidade='$cidade_cliente', estado='$uf_cliente', cep='$cep_cliente', filtroesp1='$agenda', data_agendado='$data_formatada', obs_agendado='$obs_agendada' WHERE codigo_pedido='$cod_pedido'";
	$rs2= mysql_query($query2);
