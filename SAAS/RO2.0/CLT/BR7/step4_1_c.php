...
<form name="roteiriza" action="step4_1c.php" method="post">
  <div id="apDiv13b">
   <?php
...
if($num_rows1==0){
	...
	?>
	<meta http-equiv="refresh" content="0; URL='step4_1r.php?<?php echo $rotas; ?>'"/>
<?php
} else {
...
<textarea name="check_list[]" rows="3" id="check_list[]"  hidden="hidden"><?php echo $_GET['check_list1']; ?></textarea>
