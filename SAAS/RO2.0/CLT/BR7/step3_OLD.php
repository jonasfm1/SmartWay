...
if($string0==""){
    ...
    $completa1 = " AND setor in($string0) ";
}
...
$query ="SELECT * FROM clientes WHERE roteirizado!='sim' AND ativo=0" . $completa0 . $completa1 . " order by codigo DESC";
...
<div id="mySidenav" class="sidenav">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" style="padding-top: 25px; padding-bottom: 8px; width:500px" >
		<tr>
			
		
            <td align="left" valign="middle" nowrap="nowrap" style="width:500px; color:#000000;">
            <strong><font size="4">&nbsp;LISTA DE PEDIDOS &#x2756;
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"  style="padding:4px">
			<tbody>
				<tr>
					...
					<td width="59%" align="right" bgcolor="#2867b2" style="text-align: center; font-weight: bold; color: white;">DATA INCLUSÃO</td>
	...
	<div class="header">
		<table width="100%" border="0" cellspacing="0" cellpadding="0"  style="padding:4px">
			<tbody>
				<tr>
					<td align="right" bgcolor="#2867b2" style="text-align: center; font-weight: bold;" height="35">&nbsp;</td>
					<td width="59%" align="right" bgcolor="#2867b2" style="text-align: center; font-weight: bold; color: white;">SETOR</td>
					<td width="21%" align="right" bgcolor="#2867b2" style="text-align: center; font-weight: bold;"><img src="imgs/drag&amp;drop.png" width="15" height="15" alt=""/></td>
				</tr>
			</tbody>
		</table>	
			...
			<form method="POST" name="www" id="www">
				...
				<div id='layers1'>
					<table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-left: 5px;">
						<tbody> 
							<?php
								$query_vendedor = "select * from setor";																
								...
								$query_n_vendedor = "select * from clientes where setor='$result_vendedor[$i]' and roteirizado!='sim' and ativo=0";																
