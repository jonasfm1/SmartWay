...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#579bd3; font-size: 11px; color: white" >
    <tr>
		<td align="left" valign="center" colspan="3" height="50px"><i class="material-icons" style="font-size:22px; vertical-align:bottom;padding-left: 15px;">people_outline</i><strong><font size="2px">&nbsp;DESATIVAR</font></strong>  
      </td>
    </tr>
</table>
</div>
 <div id="total">
      ...
      <form action="scripts.php?acao=altera_disable" method="POST" name="envia" id="envia">
...
<input type="submit" value="DESATIVAR" name="enviar" />
