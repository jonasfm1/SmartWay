...
$query = "select * from db_geral WHERE codigo_cliente='$_codigo'";														
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#579bd3; font-size: 11px; color: white" >
    <tr>
		<td align="left" valign="center" colspan="3" height="50px"><i class="material-icons" style="font-size:22px; vertical-align:bottom;padding-left: 15px;">people_outline</i><strong><font size="2px">&nbsp;EDITAR CLIENTE NO BANCO GERAL - CLIENTE: <?php echo $_codigo; ?></font></strong>  
      </td>
    </tr>
</table>
</div>
 <div id="total">
      ...
      <form name="editar" id="editar" action="scripts.php?acao=editar_cliente_bd" method="POST"> 
...
CIDADE:  
  ...
  <td height="35" colspan="2"   font-size:11px; font-weight:bold" name="cep" id='cep'>
    <input type="text" id="uf" name="uf" size="5px" style="height:25px; padding-left:10px" value="<?php echo $dados['estado']; ?>"required>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CEP:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="cep1" name="cep1" size="12px" style="height:25px; padding-left:10px" value="<?php echo $dados['cep']; ?>"required></td>
  </tr>
  <tr>
  <td>
  REGIÃO ITABOM:
...
$query4 = "select * from controle_regiao order by regiao ASC";	
