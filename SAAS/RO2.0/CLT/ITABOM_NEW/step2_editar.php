...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#579bd3; font-size: 11px; color: white" >
 ...
 <div id="total">
      ...
      <form name="editar" id="editar" action="scripts.php?acao=editar_cliente_step2" method="POST"> 
  <table width="100%" cellspacing="0" cellpadding="0" border="0">
   <tr>
 <td height="35"   font-size:11px; padding-left:10px; font-weight:bold"></td><td height="35"  font-size:11px; padding-left:10px; font-weight:bold"></td>
  </tr>
  <tr>
      <td>
      CÓDIGO DO CLIENTE:
...
BAIRRO:
  ...
  <td height="35"   font-size:11px; font-weight:bold">
   <input type="text" id="bairro" name="bairro" size="22px" style="height:25px; padding-left:10px" value="<?php echo $dados['bairro']; ?>"required></td>
  </tr>
<tr>
<td>
CIDADE:  
  ...
  <td height="35" colspan="2"   font-size:11px; font-weight:bold" id='uf'>
