...
$import="INSERT into clientes(codigo_cliente, codigo_pedido, volume, peso, valor, premium, classificacao, regiao_itabom, seg, ter, qua, qui, sex, sab)values('$data_0[$_conta]','$data_9[$_conta]','$data_6[$_conta]','$data_7[$_conta]', 0, '$premium_itabom', '$classif_x', '$regiao_itabom_fixo', '$seg_x', '$ter_x', '$qua_x', '$qui_x', '$sex_x', '$sab_x')";
