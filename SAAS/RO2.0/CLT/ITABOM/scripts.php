...
//	$somadata_rota = 'R' . str_pad($i_rota[$y], 2, '0', STR_PAD_LEFT) . substr($somadata_rota,0,-3);
	...
	//$somadata_rota = date("his") ;



//$dia =  date("s") +  date("z") ; 

$somadata_rota = date("dm") + ($hora + $minuto + $segundo +date("d") + date("m") + date("Y") + date("B") + date("z"));

//$somadata_rota = date("dmy") . ($hora + $minuto + date("d") + date("m") + date("Y") + date("B"));

//$somadata_rota = date("dmy") . ($hora + $minuto + date("d") + date("m") + date("Y") + date("B"));
//$somadata_rota =  $dia . $somadata_rota . date("y") ;

	$somadata_rota =$somadata_rota. str_pad($i_rota[$y], 2, '0', STR_PAD_LEFT);


//	$somadata_rota = TirarAcentos($somadata_rota);
