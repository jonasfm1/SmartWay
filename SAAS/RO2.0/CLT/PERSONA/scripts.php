...
case 'cadastra_rotas_cadd':
	...
	window.location.href="step4_1r.php?imgsel=<?php echo $qual_tipo_rota ?>&inicio=<?php echo $inicio ?>&final=<?php echo $final ?><?php echo $rotas; ?>";
...
window.location.href="step4_1_c.php?imgsel=<?php echo $qual_tipo_rota ?>&inicio=<?php echo $inicio ?>&final=<?php echo $final ?><?php echo $check_list; ?>";
