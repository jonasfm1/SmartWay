...
date_default_timezone_set('Etc/GMT+3');
	...
	$lista = $dataPedido  . "-PORTA A PORTA-(" . $today1 . ")";	
    ...
    //        $nome_cliente = $codigo_pedido . " - " . $nome_cliente;
     //       $query2 = "INSERT INTO rotas(login, rota, sequencia, x, y, idcliente, nome, endereco, cidade, classificacao, tempo, raio, status, statusrota, lista, codigo_pedido) VALUES('$login', '$rota', '$ordem', '$x', '$y', '$codigo_cliente', '$nome_cliente', '$endereco', '$cidade', '$codigo_pedido', '$tempo_servico', '$raio', '$status', 1, '$lista', '$codigo_pedido')";
  //          $rs2 = mysql_query($query2);
//
//} else {
...
*/
		...
		$search = mysql_query("SELECT * FROM db_geral WHERE codigo_cliente = '$codigo_cliente' and empresa='$empresa'");


		if(@mysql_num_rows($search) > 0){
			
		$sql = mysql_query("UPDATE db_geral SET codigo_cliente='$codigo_cliente', nome='$nome', endereco='$endereco', cidade='$cidade', estado='$estado', endereco_cad='$endereco_cad', latitude_cad='$latitude_cad', longitude_cad='$longitude_cad', confianca_cad='101', bairro='$bairro', empresa='$empresa' WHERE codigo_cliente = '$codigo_cliente'");
		
		} else {
			
		// faz inserção
		$sql = mysql_query("INSERT INTO db_geral(codigo_cliente, nome, endereco, cidade, estado, cep, endereco_cad, latitude_cad, longitude_cad, confianca_cad, bairro, empresa) VALUES('$codigo_cliente', '$nome', '$endereco', '$cidade', '$estado', '$cep', '$endereco_cad', '$latitude_cad', '$longitude_cad', '101', '$bairro', '$empresa')");
		}
