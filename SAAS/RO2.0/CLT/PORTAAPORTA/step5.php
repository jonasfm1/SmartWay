...
<tr>
    ...
    <font style="text-align: center">&nbsp;&nbsp;BAIXAR PARA O WAYOUT</font>
    </a>
    </td>
    </tr>
...
<td>
  ...
  <?php
      if ($logado=='persona_sp_pp'){
        ?>
          <a href="../../../MO2.0/index.php?l=persona_sp@persona_sp&s=persona123" target="_blank">
...
?>
  <?php
      if ($logado=='persona_mg_pp'){
        ?>
          <a href="../../../MO2.0/index.php?l=persona_mg@persona_mg&s=persona123" target="_blank">
    <font style="text-align: center">&nbsp;&nbsp;ACESSAR MONITORAMENTO</font>
    </a>
<?php
      } 
?>
  ...
  <?php
      if ($logado!='persona_sp_pp' AND $logado!='persona_mg_pp'){
        ?>
    <a href="../../../MO2.0/index.php?l=<?php echo $_SESSION['login'] . '@' . $_SESSION['login']; ?>&s=<?php echo $_SESSION['senha']; ?>" target="_blank">
    <font style="text-align: center">&nbsp;&nbsp;ACESSAR MONITORAMENTO</font>
    </a>
  <?php
      }
