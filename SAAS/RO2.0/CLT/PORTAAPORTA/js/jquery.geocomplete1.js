(function($, window, document, undefined){
  ...
  $.extend(GeoComplete.prototype, {
    ...
    initMarker: function(){
      if (!this.map){ return; }
      var options = $.extend(this.options.markerOptions, { map: this.map, icon: 'imgs/icon_start_escolha.png' });
    ...
    handleGeocode: function(results, status){
      ...
      if (status === google.maps.GeocoderStatus.OK) {
		...
		document.getElementById("multiple").innerHTML="Não contém resultados multiplos!";
		...
		document.getElementById('aparecer').style.display = 'block';
		 alert('Por favor, digite o endereço corretamente!');
      }
    },
