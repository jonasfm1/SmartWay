...
///ABRE //////DB_GERAL PROCURA IGUAIS /////////////////////////////////////			
		$queryx = "select * from db_geral WHERE codigo_cliente='$cod_cli[$conta]' AND empresa='$empresa[$conta]'";														
			...
			//$total = mysql_num_rows($rsx);
				...
				while($row1 = mysql_fetch_array($rsx)){
					...
					$_igual_empresa =  $row1["empresa"];
					//$_igual_veiculo =  $row1["veiculo"];
				}
///FECHA //////DB_GERAL PROCURA IGUAIS /////////////////////////////////////

//echo $total;
if ($id_cliente==$cod_cli[$conta] AND $_igual_empresa==$empresa[$conta]){
		$query_igual = "UPDATE clientes SET endereco_cad='$_igual_end_cad', latitude_cad='$_igual_latitude_cad', longitude_cad='$_igual_longitude_cad', confianca_cad='$_igual_confianca', geo_manual='$_igual_geomanual', codigo_db_geral='$codigo' WHERE codigo_cliente = '$cod_cli[$conta]' AND empresa='$empresa[$conta]'";
