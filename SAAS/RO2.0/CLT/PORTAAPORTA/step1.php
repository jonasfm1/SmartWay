...
for ($row =2; $row <= $highestRow; $row++)
	...
	$data_0 = str_replace("'", " ", $rowData[0][3]);	//COD CLIENTE(CONTROLE)
	$data_0 = str_replace("´", " ", $data_0);
	$data_0 = str_replace("`", " ", $data_0);
	$data_0 = str_replace("ç", "c", $data_0);
	$data_0 = str_replace("Ç", "C", $data_0);
	$data_0 = tirarAcentos($data_0);
	$data_0 = preg_replace( "/\r|\n/", "", $data_0 );

	$data_1 = str_replace("'", " ", $rowData[0][3]); 	//NOME CLIENTE
	...
	$data_2 = str_replace("'", " ", $rowData[0][4]); 	//empresa
	$data_2 = str_replace("´", " ", $data_2);
	$data_2 = str_replace("`", " ", $data_2);
	$data_2 = str_replace("ç", "c", $data_2);
	$data_2 = str_replace("Ç", "C", $data_2);
	$data_2 = tirarAcentos($data_2);
	$data_2 = preg_replace( "/\r|\n/", "", $data_2 );

	$data_3 = str_replace("'", " ", $rowData[0][18]); 	//endereco
	$data_3 = tirarAcentos($data_3);
	$data_3 = str_replace("'", " ", $data_3);	
	$data_3 = str_replace("´", " ", $data_3);
	$data_3 = str_replace("`", " ", $data_3);
	$data_3 = str_replace("ç", "c", $data_3);
	$data_3 = str_replace("Ç", "C", $data_3);
	$data_3 = str_replace("/", " ", $data_3);
	$data_3= str_replace('\\', ' ',  $data_3); 
	$data_3 = preg_replace( "/\r|\n/", "", $data_3 );

	$data_4 = str_replace("'", " ", $rowData[0][19]); 	//numero endereco
	$data_4 = preg_replace( "/\r|\n/", "", $data_4 );

	$endereco_completo = $data_3 . ", " . $data_4;


	$data_5 = str_replace("'", " ", $rowData[0][21]); 	//cep

	$data_6 = str_replace("'", " ", $rowData[0][22]); 	//bairro
	$data_6 = str_replace("´", " ", $data_6);
	$data_6 = str_replace("`", " ", $data_6);
	$data_6 = str_replace("ç", "c", $data_6);
	$data_6 = str_replace("Ç", "C", $data_6);
	$data_6 = tirarAcentos($data_6);
	$data_6 = preg_replace( "/\r|\n/", "", $data_6 );

	$data_7 = str_replace("'", " ", $rowData[0][23]); 	//cidade
	$data_7 = str_replace("´", " ", $data_7);
	$data_7 = str_replace("`", " ", $data_7);
	$data_7 = str_replace("ç", "c", $data_7);
	$data_7 = str_replace("Ç", "C", $data_7);
	$data_7 = tirarAcentos($data_7);
	$data_7 = preg_replace( "/\r|\n/", "", $data_7 );

	$data_8 = str_replace("'", " ", $rowData[0][24]); 	//UF
	$data_8 = preg_replace( "/\r|\n/", "", $data_8 );


	$data_9 = str_replace("'", " ", $rowData[0][16]); 	//CODIGO PEDIDO CODIGO BARRA
	$data_9 = preg_replace( "/\r|\n/", "", $data_9 );

	$data_10 = str_replace("'", " ", $rowData[0][14]); 	//CESTA MODELO
	$data_10 = preg_replace( "/\r|\n/", "", $data_10 );

	$data_11 = str_replace("'", " ", $rowData[0][26]); 	//GUIA
	$data_11 = preg_replace( "/\r|\n/", "", $data_11 );

	$data_12 = str_replace("'", " ", $rowData[0][13]); 	//VOLUME QTO CESTAS
	$data_12 = preg_replace( "/\r|\n/", "", $data_12 );

	$data_13 = str_replace("'", " ", $rowData[0][40]); 	//PESO CESTAS
	$data_13 = number_format($data_13, 2, '.', '');
	...
	$data_6 = utf8_encode($data_6);
	$data_7 = utf8_encode($data_7);
	$data_8 = utf8_encode($data_8);
	$data_9 = utf8_encode($data_9);
	$data_10 = utf8_encode($data_10);
	$data_11 = utf8_encode($data_11);


	$endereco_completo = utf8_encode($endereco_completo);
...
$query_where_verifica =  mysql_query("SELECT codigo_cliente from clientes where codigo_cliente='$data_0'");
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	$import="INSERT into clientes(codigo_cliente, nome, empresa, endereco, cidade, bairro, estado, cep, peso, volume, valor, premium, codigo_pedido, marca, loja)values('$data_0','$data_1','$data_2','$endereco_completo','$data_7','$data_6','$data_8','$data_5', $data_13, $data_12, 0, 'A', '$data_9', '$data_10', '$data_11')";
	mysql_query($import) or die(mysql_error());
	}
...
$query = "select codigo_cliente,nome,endereco_cad,latitude_cad,longitude_cad,confianca_cad,codigo from db_geral where codigo_cliente='$data_0' AND empresa='$data_2'";														
