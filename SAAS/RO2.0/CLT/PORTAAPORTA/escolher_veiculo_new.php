...
#apDiv5_top {
	...
	top: 2px;
	margin-bottom:8px;
	background:url(imgs/box_veiculo_step3_pop_x.png);
}
...
<div id="div_geral">
   ...
   <tr>
       ...
       <font size="4"><strong>&nbsp;ESCOLHA DE VEÍCULO LIVRE -</strong></font>
       
       </td>
       <td>
       <?php echo "<font size='3'>" .  "PESO: <strong>" . $_pesox . " - </strong></font>";?>
       </td>
	   <td>
       <?php echo "<font size='3'>" .  "VOLUME: <strong>" . $_volumex . " - </strong></font>";?>
       </td>

	   <td>
       <?php echo "<font size='3'>" .  "VALOR: <strong>" . $_valorx . "</strong></font>";?>
       </td>
...
<form method="post" name="veiculo_escolha" id="veiculo_escolha" action="scripts.php?acao=cadastra_equipe_veiculo_novo">
  		
		  <input type="hidden" id="zoom" name="zoom" size="5" value="<?php echo $_GET['zoom2'] ?>"/>
		  <input type="hidden" id="zoom_x" name="zoom_x" size="5" value="<?php echo $_GET['zoom_x2'] ?>"/>
		  
		  
		  <input type="hidden" id="tool01_x" name="tool01_x" size="5" value="<?php echo $_GET['posX'] ?>"/>
		  <input type="hidden" id="tool01_y" name="tool01_y" size="5" value="<?php echo $_GET['posY'] ?>"/>
		  
		  <input type="hidden" id="tool02_x" name="tool02_x" size="5" value="<?php echo $_GET['posX_tools'] ?>"/>
		  <input type="hidden" id="tool02_y" name="tool02_y" size="5" value="<?php echo $_GET['posY_tools'] ?>"/>
		  
		  <input type="hidden" id="tool03_x" name="tool03_x" size="5" value="<?php echo $_GET['posX_layers'] ?>"/>
		  <input type="hidden" id="tool03_y" name="tool03_y" size="5" value="<?php echo $_GET['posY_layers'] ?>"/>
		   
		   
			<input type="hidden" id="pesox" name="pesox" size="5" value="<?php echo $_GET['pesox'] ?>"/>
		 <input type="hidden" id="volumex" name="volumex" size="5" value="<?php echo $_GET['volumex'] ?>"/>
		 <input type="hidden" id="valorx" name="valorx" size="5" value="<?php echo $_GET['valorx'] ?>"/>
		 
		 <input name="equipe_poligonox" id="equipe_poligonox" type="hidden" size="12" value="<?php echo $_GET['equipe_poligonox'] ?>"/>
		 <input name="veiculo_tirax" size="12" id="veiculo_tirax" type="hidden" value="<?php echo $_GET['veiculo_tirax'] ?>">
		 <input name="peso_veiculo_tirax" type="hidden" id="peso_veiculo_tirax" size="12" value="<?php echo $_GET['peso_veiculo_tirax'] ?>"/>
		  <input name="volume_veiculo_tirax" type="hidden" id="volume_veiculo_tirax" size="12" value="<?php echo $_GET['volume_veiculo_tirax'] ?>"/>    
		 <input name="valor_veiculo_tirax" type="hidden" id="valor_veiculo_tirax" size="12" value="<?php echo $_GET['valor_veiculo_tirax'] ?>"/>
		 <input name="endereco_clientex" id="endereco_clientex" type="hidden" size="12" value="<?php echo $_GET['endereco_clientex'] ?>"/>

<td align='center' nowrap="nowrap">

<input name="id_veiculox" onChange="this.form.submit();" type="radio" value="<?php echo $row_veiculo["id"]?>" <?php if($id1==$row_veiculo["id"]) echo "checked";?> />
...
<td  style="padding-left: 5px;" nowrap="nowrap"><?php echo $calcula_valor ?>
<input name="tipox" id="tipox" type="hidden" size="12" value="<?php echo $row_veiculo['tipo']?>" />
	   <input name="type_iconx" id="type_iconx" type="hidden" size="12" value="<?php echo $row_veiculo['type_icon']?>" />
       <input name="peso2x" id="peso2x" type="hidden" size="12" value="<?php echo $row_veiculo['peso']?>" />
       <input name="volume2x" id="volume2x" type="hidden" size="12" value="<?php echo $row_veiculo['volume']?>"/>
       <input name="valor2x" id="valor2x" type="hidden" size="12" value="<?php echo $row_veiculo['valor']?>" /> 
          
       <input name="peso_existente" id="peso_existente" type="hidden" size="12" value="<?php echo $row_veiculo["peso_total"] ?>"/>
       <input name="volume_existente" id="volume_existente" type="hidden" size="12" value="<?php echo $row_veiculo["volume_total"] ?>"/>
       <input name="valor_existente" id="valor_existente" type="hidden" size="12" value="<?php echo $row_veiculo["valor_total"] ?>"/>
	   </td>
</tr>
</form>
<?php
