...
<br>
 <table width="100%" border="1" class="bordasimples" cellpadding="2" cellspacing="2">
    ...
    <tr style="text-transform:uppercase;font-weight: bold;color: #000000;" bgcolor="#ECECEC">
      <td  height="20" nowrap style="padding-top: 15px; padding-left:5px">Nome</td>
      <td  height="20" nowrap style="padding-top: 15px; padding-left:5px">Empresa</td>
      <td  height="20" nowrap style="padding-top: 15px; padding-left:5px">Modelo</td>
      ...
      <td   nowrap style="padding-top: 15px; padding-left:5px">Guia</td>
...
?>
      ...
      <td  style="padding-left: 5px;"><?php echo $nome_cliente ?></td>
      <td  style="padding-left: 5px;"><?php echo $empresa ?></td>
      <td  style="padding-left: 5px;"><?php echo $marca ?></td>
      ...
      <td  style="padding-left: 5px;" ><?php echo $guia ?></td>
