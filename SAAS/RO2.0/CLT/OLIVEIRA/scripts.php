...
?>
				  <td>
				  <span class="material-icons" style="font-size: 48px;color:#FF0000">app_settings_alt</span>
				  </td>
				  <td>
				 <strong><p class="modal-title" id="exampleModalLongTitle" style="text-align: left;">&nbsp;&nbsp;ESSES PEDIDOS JÁ FORAM IMPORTADOS</p></strong> 
				  </td>
				  <?php
	  } else {
?>
...
?>
	  ...
	  &nbsp;&nbsp;Total de pedidos: <?php  echo $num_rows_pedidos; ?><br>
	  &nbsp;&nbsp;Pedidos duplicados: <?php  echo $conta_iguais; ?><br>
<?php
	  } else {
?>
	  ...
	  &nbsp;&nbsp;Total de pedidos: <?php  echo $num_rows_pedidos; ?><br>
	  &nbsp;&nbsp;Pedidos duplicados: <?php  echo $conta_iguais; ?><br>
	  &nbsp;&nbsp;Pedidos importados: <?php  echo $conta_diferente;?>
<?php
	  }
?>
...
while ($row = mysql_fetch_array($seleciona)) {
		...
		//NAO FICAR VAZIO ESSE CAMPO, ERRO NO ERP
		if($data_entrega==''){
		...
		if($total_integrado>0){
			...
			$import2="UPDATE pedidos_input SET codigo_cliente='$codigo_cliente', nome_cliente='$nome_cliente', nome_veiculo='$nome_veiculo', nome_rota='$nome_rota', data_entrega='$data_entrega' where pedido='$codigo_pedido'";
			mysql_query($import2) or die(mysql_error());

		} else {
			$import2="INSERT into pedidos_input(pedido, codigo_cliente, nome_cliente, nome_veiculo, nome_rota, data_entrega)values('$codigo_pedido', '$codigo_cliente', '$nome_cliente', '$nome_veiculo', '$nome_rota', '$data_entrega')";
			mysql_query($import2) or die(mysql_error());
