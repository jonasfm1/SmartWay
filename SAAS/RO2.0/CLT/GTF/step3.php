...
if($posx==0 AND $posy==0){
	...
	$posx_filtro_vendedor= 617;
	$posy_filtro_vendedor= 0;	

	$posx_filtro_legenda= 822;
	$posy_filtro_legenda= 0;	
...
$(document).ready(function(){
  var elementOffset = $('#legenda').offset({top:<?php echo $posy_filtro_legenda ?>,left:<?php echo $posx_filtro_legenda ?>});
});
...
if($string0==""){
    ...
    $completa1 = " AND vendedor in($string0) ";
}
...
$query ="SELECT * FROM clientes WHERE roteirizado!='sim' AND ativo=0" . $completa0 . $completa1;
...
//	$query_agrupar = "select * from clientes where codigo_cliente in(select B.codigo_cliente from clientes B group by B.codigo_cliente having count(*)>1)";
	$query_agrupar = "select *, COUNT(codigo_cliente) AS Qtd, SUM(peso) AS Qtd_peso, SUM(volume) AS Qtd_volume, SUM(valor) AS Qtd_valor from clientes where roteirizado!='sim' AND ativo=0 " . $completa0 . $completa1 . "group by codigo_cliente having count(codigo_cliente)>1";
...
for ($i = 0; $i < $mrk_cnt; $i++){
	...
	//	$arruma_string =	$id_cliente[$i];
	//echo ($id_cliente[$i]);
		
		echo "point$i = new google.maps.LatLng($lat_cad[$i],$lng_cad[$i]);\n";
		
		
		//$guarda = "h=" . $lat_cad[$i] . "&v=" . $lng_cad[$i] . "&reg=" . $codigo_pedido[$i] . "&endereco=" . $endereco_cli_mesmo[$i] . "&codigo=" . $codigo_pedido[$i] . "&cod_cli=" . $codigo_pedido[$i] . "&nome=" . $string_menor[$i] . "&cidade=" . $cidade[$i] . "&uf=" . $estado[$i] . "&cep=" . $cep[$i] . "&peso=" . $peso[$i] . "&valor=" . $valor[$i] . "&volume=" . $volume[$i];


		
    	echo "mrktx$i = \"<div id='iw_container'><div class='iw_title' style='background-color:#589bd4'><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='30px'><img src='imgs/ico_realizado.png' width='22' height='22'/></td><td style='text-wrap:normal;width:400'>$string_menor[$i] ($id_cliente[$i])</td></tr></table></div><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='40px'></td><td style='padding-top:20px; padding-bottom:5px; font-size:11px'><strong>PEDIDO:</strong> $codigo_pedido[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><strong>PESO:</strong> $peso[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><strong>VOLUME:</strong> $volume[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><strong>VALOR:</strong> $valor[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><strong>END.:</strong>$end_menor[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><strong>BAIRRO/CIDADE: </strong>$bairro[$i], $cidade[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><strong>OBS.: </strong>$obs_pedido1[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><a href='javascript:geo(id_cliente_js[$i])';> <i class='material-icons' style='font-size:20px; vertical-align:bottom'>edit_location_alt</i>&nbsp;LOCALIZAR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a><a href='javascript:editar(id_cliente_js[$i])';><i class='material-icons' style='font-size:20px; vertical-align:bottom'>edit</i>&nbsp;EDITAR</a></td></tr></table></div>\";";
		...
		echo "mrktx$i = \"<div id='iw_container'><div class='iw_title' style='background-color:#589bd4'><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='30px'><img src='imgs/ico_realizado.png' width='22' height='22'/></td><td width='420px'>$string_menor[$i] ($id_cliente[$i])</td></tr></table></div><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='40px'></td><td style='padding-top:20px; padding-bottom:5px; font-size:11px'><strong>PEDIDO:</strong> $codigo_pedido[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><strong>PESO:</strong> $peso[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><strong>VOLUME:</strong> $volume[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><strong>VALOR:</strong> $valor[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><strong>END.:</strong>$end_menor[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><strong>BAIRRO/CIDADE: </strong>$bairro[$i], $cidade[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><strong>OBS.: </strong>$obs_pedido1[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><a href='javascript:geo(id_cliente_js[$i])';> <i class='material-icons' style='font-size:20px; vertical-align:bottom'>edit_location_alt</i>&nbsp;LOCALIZAR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a><a href='javascript:editar(id_cliente_js[$i])';><i class='material-icons' style='font-size:20px; vertical-align:bottom'>edit</i>&nbsp;EDITAR</a></td></tr></table></div>\";";
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" style=padding-bottom: 8px; width:500px" >
		<tr>
			...
			if($veiculo1!=''){
				...
				if(round($porc_peso)>100 OR round($porc_volume)>100 OR round($porc_valor)>100){
					?>
					<script>
				...
				$query = "select latitude_cad, longitude_cad, endereco_cad, confianca_cad, codigo, codigo_pedido, codigo_cliente, nome, endereco, cidade, estado, cep, peso, volume, valor, obs_pedido, classificacao, veiculo from clientes WHERE veiculo='$id1' $completa0 $completa1 order by codigo_cliente";																
				$rs = mysql_query($query);
				...
				$query = "select latitude_cad, longitude_cad, endereco_cad, codigo, codigo_pedido, codigo_cliente, nome, endereco, cidade, estado, cep, peso, volume, valor, obs_pedido, classificacao, veiculo from clientes where roteirizado!='sim' $completa0 $completa1 order by veiculo DESC, codigo_cliente ASC";																
				$rs = mysql_query($query);
				$totalderegistros = mysql_num_rows($rs);
...
<table border="3"  id="demo" name="demo" class="tablesorter" style="width: 330px;">
<thead>
<tr style="height: 35px; background-color:#ECECEC"  class="active">
...
<div align="center" nowrap='nowrap' >ZOOM</div>
</th>
...
<th  nowrap="nowrap" headers="icone" bgcolor="#00000" style="color:#000000; width:10px" class="drag-enable" title="DATA"> 
...
<td align="center" nowrap='nowrap' title="<?php echo $row["classificacao"] ?>" >
...
<a href="javascript:confirmaExclusao2('scripts.php?acao=exclui_pedido_veiculo_individual&id=<?php echo $row["codigo"] . "&veiculo=" . $row["veiculo"] . "&p=" . $row["peso"] . "&v=" . $row["volume"] . "&va=" . $row["valor"]; ?>&cod_pedido=<?php echo $row["codigo_pedido"]; ?>&dt_inclusao=<?php echo $row["classificacao"]; ?>')"><i class="material-icons" style="font-size:14px; color:#FF0000">remove_circle</i></a>

<?php
} else {
?>

<a href="javascript:confirmaExclusao2('scripts.php?acao=exclui_pedido_veiculo_geral&id=<?php echo $row["codigo"] . "&veiculo=" . $row["veiculo"] . "&p=" . $row["peso"] . "&v=" . $row["volume"] . "&va=" . $row["valor"]; ?>&cod_pedido=<?php echo $row["codigo_pedido"]; ?>&dt_inclusao=<?php echo $row["classificacao"]; ?>')"><i class="material-icons" style="font-size:14px; color:#FF0000">remove_circle</i></a>
...
?>
<a href="javascript:confirmaExclusao2('scripts.php?acao=exclui_pedido&id=<?php echo $row["codigo"]; ?>&cod_pedido=<?php echo $row["codigo_pedido"]; ?>&dt_inclusao=<?php echo $row["classificacao"]; ?>')"><i class="material-icons" style="font-size:14px; color:#FF0000">remove_circle</i></a>
<?php
}
...
<div class="container" id="makeMeDraggable2" name="makeMeDraggable2">
	<div class="header">
	<table width="100%" border="0" cellspacing="0" cellpadding="0"  style="padding:0px">
			<tbody>
				<tr>
				<td align="right" bgcolor="#589bd4" style="text-align: left; font-weight: bold;" height="32">&nbsp;</td>
				<td width="20%" align="right" bgcolor="#589bd4" style="text-align: center; font-weight: bold;"><span class="material-icons" style="font-size: 16px;color:white">date_range </span></td>
					<td width="80%" align="left" bgcolor="#589bd4" style="text-align: left; font-weight: bold; color: white;">DATA</td>
			</tr>
			</tbody>
		</table>	
	</div>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tbody> 
							<?php
								...
								$query_n = "select * from clientes where classificacao='$result[$i]' and roteirizado!='sim' and ativo=0"  . $completa1;																
...
<div class="container" id="makeMeDraggable3">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"  style="padding:0px">
			<tbody>
				...
				<td width="20%" align="right" bgcolor="#589bd4" style="text-align: center; font-weight: bold;"><span class="material-icons" style="font-size: 16px;color:white">group </span></td>
					<td width="80%" align="left" bgcolor="#589bd4" style="text-align: left; font-weight: bold; color: white;">VENDEDOR</td>
			</tr>
			</tbody>
		</table>		
	</div>
	...
	<div class="content" id='legendas_layer3'>
			...
			<form action="" method="POST" name="www" id="www">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-left: 5px;">
						<tbody> 
							<?php
								...
								$result_vendedor[] = $row3_vendedor["vendedor"];

								$query_n_vendedor = "select * from clientes where vendedor='$result_vendedor[$i]' and roteirizado!='sim' and ativo=0" . $completa0;																
							...
							//	echo $result[$i] . '(' . $cont . ')';
								echo mb_strimwidth($result_vendedor[$i], 0, 20, "...") . '(' . $cont_vendedor . ')';
								?></td>
								<?php
								}
								?>
...
function toggle_vendedor(checked) {
  var elm = document.getElementByName('vendedor[]');
...
<div id='layers2'>
  ...
  <?php if ($tipo1=="3-4"){ ?><img src="imgs/<?php echo "v01_" . $cor_veiculo_resgate . ".png";  ?>" height='20px'/><?php } ?>
...
<div class ="container" id="legenda" name="legenda" onmouseout="return false"> 
	<div class="header">
	<table width="100%" border="0" cellspacing="0" cellpadding="0"  style="padding:0px">
			<tbody>
				<tr>
				<td align="right" bgcolor="#589bd4" style="text-align: left; font-weight: bold;" height="32">&nbsp;</td>
				<td width="20%" align="right" bgcolor="#589bd4" style="text-align: center; font-weight: bold;"><span class="material-icons" style="font-size: 16px;color:white">near_me </span></td>
					<td width="80%" align="left" bgcolor="#589bd4" style="text-align: left; font-weight: bold; color: white;">LEGENDA</td>
			</tr>
			</tbody>
		</table>	
	</div>  
	...
	<form action="" method="POST" name="yyy" id="yyy">
				...
				<div id='layers_legenda'>
					<table width="150px" border="0" cellspacing="0" cellpadding="0" style="margin-left: 15px">
						<tbody> 
							<?php
								$query_icones = "select * from clientes group by premium";																
								$rs_icones = mysql_query($query_icones);	
								$i=0;							
								while($row_icones = mysql_fetch_array($rs_icones)){

								$result_icone[] = $row_icones["premium"];
//echo $result_icone[$i];
								$query_legenda = "select * from clientes where premium='$result_icone[$i]' and roteirizado!='sim' and ativo=0";																
								$rs_legenda = mysql_query($query_legenda);	
								$cont_lengenda = mysql_num_rows($rs_legenda);


								if($result_icone[$i]=="A"){
									$texto_legenda = "ACIMA DE 5500KG";
									$cor_icon = "#000000";

								}
								if($result_icone[$i]=="B"){
									$texto_legenda = "2500KG ATÉ 5500KG";
									$cor_icon = "#f0f842";
								}
								if($result_icone[$i]=="C"){
									$texto_legenda = "1200KG ATÉ 2500KG";
									$cor_icon = "#42c8f7";

								}
								if($result_icone[$i]=="I"){
									$texto_legenda = "600KG ATÉ 1200KG";
									$cor_icon = "#e48e31";
									
								}
								if($result_icone[$i]=="S"){
									$texto_legenda = "250KG ATÉ 600KG";
									$cor_icon = "#98f544";

								}
								if($result_icone[$i]=="V"){
									$texto_legenda = "18KG ATÉ 250KG";
									$cor_icon = "#dc3e92";
								...
								<td align="right" style="text-align: center;background-color:<?php echo $cor_icon ?>; height:10px; width:15px;" >
								
								</td>
								<td colspan="2" valign="middle" style="text-align: left; padding-left: 10px" title="<?php echo $texto_legenda;?>"><?php 
								echo $texto_legenda . '(' . $cont_lengenda . ')';
								?></td>
								<?php
								}
								?>
