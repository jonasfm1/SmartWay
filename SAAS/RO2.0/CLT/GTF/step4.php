...
<div id="mySidenav" class="sidenav">
  ...
  <input type="radio" id="rotas" name="imgsel" value="rotas"  checked="checked"/><font size='2'>&nbsp;&nbsp;Ponto-a-ponto<strong>(Ilimitado)</font></strong>
...
<tr>
	<td nowrap="nowrap">
  <input type="radio" name="imgsel" id="google" value="google"/><font size='2'>&nbsp;&nbsp;Formato pétala<strong>(Limitado a 25 pontos)</font></strong>
	</td>
</tr>
...
<?php if ($tipo=="Moto"){ ?><img src="imgs/<?php echo "v06_" . $type_icon . ".png";  ?>" height="8px"/><?php } ?>
  ...
  <?php if ($tipo=="3-4"){ ?><img src="imgs/<?php echo "v01_" . $type_icon . ".png";  ?>" height="8px"/><?php } ?>
