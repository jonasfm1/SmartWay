...
?>
<tr bgcolor="#FFF"> 
<td align="center" ><?php echo $row["loja"];?></td>
<td align="center" nowrap="nowrap"><?= $row["codigo_pedido"] ?></td>	
<td align="center" nowrap="nowrap"><?php echo $queme?></td>
<td align="center" nowrap="nowrap"><?php echo $row["tipo_veiculo"];?></td>
<td align="center" nowrap="nowrap"><?php echo $row["cod_vendedor"];?></td>
<td align="center" nowrap="nowrap" > <?= mb_strimwidth($row["vendedor"], 0, 20, "...");?></td>
<td align="center" nowrap="nowrap"><?php echo $row["codigo_cliente"];?></td>
	
<td align="center" nowrap="nowrap"><?= mb_strimwidth($row["nome_cliente"], 0, 30, "...");?></td> 	
<td align="center" nowrap="nowrap"><?= mb_strimwidth($row["endereco"], 0, 30, "...");?></td>
<td align="center" nowrap="nowrap"><?= $row["bairro"] ?></td>
<td align="center" nowrap="nowrap"><?= $row["cidade"] ?></td>
...
<td align="center" nowrap="nowrap"><?= $row["cep"] ?></td>
<td align="center" nowrap="nowrap" > <?= $row["cod_produto"] ?></td>
<td align="center" nowrap="nowrap" > <?= $row["cod_cancao"] ?></td>
...
<tr>
    ...
    <font style="text-align: center">&nbsp;&nbsp;BAIXAR PARA O PROTHEUS</font>
    </a>
    </td>
    </tr>
    ...
    <tr>
	<td nowrap="nowrap" style="width: 20px">
	<i class="material-icons" style="font-size:22px; vertical-align:bottom">file_download</i>
    </td>
    <td nowrap="nowrap">
  
    <a href="#"  onClick="acao_imprimir();" >
    <font style="text-align: center">&nbsp;&nbsp;BAIXAR FORMATO .ZIP</font>
    </a>
    </td>
    </tr>
    <tr>
    ...
    <a href="#"  onClick="acao_imprimir_rar();" >
    <font style="text-align: center">&nbsp;&nbsp;BAIXAR FORMATO .RAR</font>
    </a>
    </td>
    </tr>
        </table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" style="padding-top: 25px; padding-bottom: 8px; width:100%" >
  ...
  <form action="#" method="get" name="myForm" id="myform">
    <a href="../../../MO2.0/index.php" target="_blank">
