...
case 'exclui_pedido_veiculo_individual':
	...
	$import="INSERT into excluidos(codigo_pedido, usuario, data, data_inclusao)values('$cod_pedido', '$logado', '$hoje', '$dt_inclusao')";
...
if ($conta_peso_paratirar <= 0.00 and $conta_volume_paratirar <= 0.00 and $conta_valor_paratirar <= 0.00){
	$query6 = "UPDATE veiculos SET peso_total='$conta_peso_paratirar', volume_total='$conta_volume_paratirar', valor_total='$conta_valor_paratirar', equipe=null, ocupado=0, prioridade=Null WHERE id = '$iparr1[$y]'";
...
if($transp==''){
	...
	$query3 = "UPDATE rotas SET veiculo='$i_id_veiculo[$y]', transportadora='$transp', nome_rota='$somadata_rota', ordem='$i_ordem[$y]', distancia='$i_distancia[$y]', tempo='$i_tempo[$y]' WHERE id = '$i_id_cliente[$y]'";
