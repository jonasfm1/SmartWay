 ...
 <table width="100%" border="1" class="bordasimples" cellpadding="2" cellspacing="2">
  <tbody>
        <tr bgcolor="#888888">
          ...
          <td width="11%" style="text-align: center; color: #ffffff;">Peso Total</td>
          <td width="11%" style="text-align: center; color: #ffffff;">Valor Total</td>
    </tr>
<?php 
  include ('session.php'); 
...
<tr>
      ...
      <td style="text-align: center"><?php echo $dados['peso_total']; ?></td>
      <td style="text-align: center"><?php echo $dados['valor_total']; ?></td>
	  ...
	  ?>
       ...
       <tr bgcolor="#cccccc">
      <td height="5" colspan="8" align="right"></td>
    </tr>
