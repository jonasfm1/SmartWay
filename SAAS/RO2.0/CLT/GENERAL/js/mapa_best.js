 ...
 ///////////////////////////////////////////////////////////	
 	...
 	//alert(JSON.stringify(array_segura_lista_clientes, null, 4));
			...
			//	maismais = i + 1;
				...
				document.getElementById('div16').innerHTML += '<table width="100%" height="40px;" border="0" cellpadding="0" cellspacing="0" class="div_nova2_tabela"><tbody><tr><td width="50%;" align="left"><img src=' + "'" + junta_veiculo[i].veiculo + "'" +  "width='30' height='28' /></td><td width='50%'>Pedidos: " + "<font size='4px'><b>" + data3.length + "</b></font></td></tr></tbody></table>";
	...
	document.getElementById(vistitaae).innerHTML += "<p><strong>&nbsp;&nbsp;&nbsp;&nbsp;</strong>" + pontos(guarda_primeiroponto_nomeveiculo, 36) + " - <strong>" + 	guarda_primeiroponto_distancia.toFixed(1) + " Km</strong></p>";	
	...
	for (var w = 0; w < data_ok; w++) {
						...
						/*	/// zero antes do nemuro ate 10 ////
							...
							document.getElementById(vistitaae).innerHTML += "<p><strong>&nbsp;&nbsp;&nbsp;&nbsp;</strong>" + pontos(meu_array[i][w], 36) + " - <strong>" + meu_distancia[i][w].toFixed(1) + " Km</strong></p>";	
