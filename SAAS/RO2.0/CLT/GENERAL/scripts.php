...
//} else {
            ...
            $query2 = "INSERT INTO rotas(login, rota, sequencia, x, y, idcliente, nome, endereco, cidade, classificacao, tempo, obs, raio, status, statusrota, lista, codigo_pedido, peso, volume, valor, motorista) VALUES('$login', '$rota', '$ordem', '$x', '$y', '$codigo_cliente', '$nome_cliente', '$endereco', '$cidade', '$codigo_pedido', '$tempo_servico', '$obs_pedido', '$raio', '$status', 1, '$lista', '$codigo_pedido', $peso, $volume, $valor, '$motorista')";
            $rs2 = mysql_query($query2);
