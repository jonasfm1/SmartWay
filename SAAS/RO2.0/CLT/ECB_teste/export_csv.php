...
$html .= '<td  colspan="9" bgcolor="#c9c9c9"><strong style="font-size:17px;">' . "DATA " . date("d m Y") . " " . "PLACA <b>" . $queme . "</b> - " . $queme_transp . '</strong></td>';
$html .= '</tr>';	
...
$html .= '<td nowrap align="right"><b>VOLUME</b></td>';
$html .= '<td nowrap><b>OBS.</b></td>';
$html .= '</tr>';
...
$html .= '<td align="left" nowrap><b>' . $id_cliente . '</b></td>';
...
$html .= '<td align="left" nowrap  align="right"><b>' . $volume1 . '</b></td>';
...
$html .= '</tr>';	
	...
	$soma_valor = str_replace(".", ",", $soma_volume);
}
