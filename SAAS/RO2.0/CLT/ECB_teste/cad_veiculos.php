...
<input name="id_veiculo" type="hidden" id="id_veiculo" value="<?php echo $id_quem;  ?>" />
  ...
  <td style="height: 20px;">
    ...
    <td style="height: 20px;"><font color="#808080">&nbsp;&nbsp;MOTO</font></td>
    </tr>
    <tr>
...
<tr>
  <td > <input name="veiculo" type="text" id="veiculo" placeholder="PLACA DO VEÍCULO" value="<?php echo $row1["nome"];  ?>"/></td>
</tr>
<tr>
  <td> <input name="custo" type="text" id="custo" placeholder="SETOR" value="<?php echo $row1["setor"];  ?>"/></td>
  </tr>
  <tr>
  <td><input name="transp1" type="text" id="transp1" placeholder="TRANSPORTADORA"  value="<?php echo $row1["transportadora"];  ?>"/></td>
  </tr>
  <tr>
  <td><input type="text" name="peso" id="textfield"  placeholder="PESO (EXEMPLO.: 20000)" value="<?php echo $row1["peso"];  ?>"/></td>
  </tr>
  <tr>
  <td><input type="text" name="volume" id="textfield"   placeholder="VOLUME (EXEMPLO.: 200)" value="<?php echo $row1["volume"];  ?>"/></td>
  </tr>
  <tr>
  <td> <input type="text" name="valor" id="textfield"   placeholder="VALOR (EXEMPLO.: 1000000)" value="<?php echo $row1["valor"];  ?>"/></td>
  </tr>
  <tr>
  <td> <input type="text" name="custo1" id="textfield"  placeholder="CUSTO DO VEÍCULO (EXEMPLO.: 0.234)" value="<?php echo $row1["custo"];  ?>"/></td>
  </tr>
  <tr height='40px'>
...
<table width="80" border="0" cellspacing="0" cellpadding="0" class="bordasimples">
  <tr>
    ...
    <td style="height: 20px;"><input name="type" type="radio" value="Moto" /></td>
    <td><font color="#808080">&nbsp;&nbsp;MOTO</font></td>
   </tr>
   <tr>
...
<tr>
  <td> <input name="custo" type="text" id="custo" placeholder="SETOR"/></td>
  </tr>
  <tr>
  <td><input name="transp1" type="text" id="transp1" placeholder="MOTORISTA"/></td>
  </tr>
  <tr>
  <td><input type="text" name="peso" id="textfield"  placeholder="PESO (EXEMPLO: 20000)"/></td>
  </tr>
  <tr>
  <td><input type="text" name="volume" id="textfield"   placeholder="VOLUME (EXEMPLO: 200)"/></td>
  </tr>
  <tr>
  <td> <input type="text" name="valor" id="textfield"   placeholder="VALOR (EXEMPLO: 1000000)"/></td>
  </tr>
  <tr>
  <td> <input type="text" name="custo1" id="textfield"  placeholder="CUSTO DO VEÍCULO (EXEMPLO: 0.234)" /></td>
  </tr>
  <tr height='40px'>
...
<th nowrap="nowrap" headers="icone" bgcolor="#00000" style="color:#000000; " class="drag-enable" title="MOTORISTA">
...
if ($_seleciona!=null){
	...
	$query = "select * from veiculos order by ativo desc, nome asc, tipo asc";	
...
<td nowrap align="center" ><a href="javascript:confirmaExclusao('scripts.php?acao=exclui_veiculo&id=<?php echo $row["id"] ?>')"><span class="material-icons" style="font-size: 14px;color:red">remove_circle</span></a></td>
...
<td nowrap align="center" ><?php echo $row["setor"] ?></td>
