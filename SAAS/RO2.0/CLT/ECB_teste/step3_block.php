...
function acao_deleta(veiculo) {


var teste = "scripts.php?acao=deleta_veiculo&veiculo=" + veiculo;


if(confirm('Você tem certeza que deseja esvaziar esse veículo? O veículo ficará livre e seus pedidos serão excluidos do Sistema. Tenha certeza que os pedidos já foram integrados.')) {
...
<tr>
<td>
<form action='scripts.php?acao=esvaziar_veiculos_integrados' method='POST'>
<input type='submit' name="escolha" value='ESVAZIAR VEÍCULOS INTEGRADOS'/>
</form>
</td>
<td>
<?php
if($senha=='cibele'){
?>
<form action='scripts.php?acao=esvaziar_veiculos_nao_integrados' method='POST'>
<input type='submit' name="escolha" value='ESVAZIAR VEÍCULOS NÃO INTEGRADOS'/>
</form>
<?php
}
?>
...
<th nowrap="nowrap" headers="check" bgcolor="#00000" style="color:#000000; width:30px" class="drag-enable" title="CHECK">
...
<th nowrap="nowrap" headers="icone" bgcolor="#00000" style="color:#000000;" class="drag-enable" title="INTEGRADO">
<div align="center" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;INTEGRADO</div>
</th>
<th nowrap="nowrap" headers="icone" bgcolor="#00000" style="color:#000000;" class="drag-enable" title="ESVAZIAR VEÍCULO">
<div align="center" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ESVAZIAR</div>
</th>
</tr>
</thead>
<tbody>
...
<td align="center" style="padding-left: 5px;"><?php echo $row["nome"] ?></td>
<td nowrap="nowrap" align="center" style="padding-left: 5px;"><?php echo $row["transportadora"] ?></td>
<td nowrap align="center" style="padding-left: 5px;"><?php echo $row["tipo"] ?></td>
<td nowrap align="center" style="padding-left: 5px;"><?php echo $row["peso"] ?></td>
<td nowrap align="center" style="padding-left: 5px;"><?php echo $row["peso_total"] ?></td>
<td nowrap align="center" style="padding-left: 5px;"><?php echo $row["volume"] ?></td>
<td nowrap align="center" style="padding-left: 5px;"><?php echo $row["volume_total"] ?></td>
<td nowrap align="center" style="padding-left: 5px;"><?php echo $row["valor"] ?></td>
<td nowrap align="center" style="padding-left: 5px;"><?php echo $row["valor_total"] ?></td>

<?php 
     if($row["integrado"]==1){
?>
     <td align="center">
     <i class="material-icons" style="font-size:16px; vertical-align:bottom; color:green;">verified</i>
    </td>
<?php
     } else {
?>
     <td  align="center">
     <i class="material-icons" style="font-size:16px; vertical-align:bottom; color:red;">warning</i>
    </td>
<?php
...
<?php 
     if($row["integrado"]==1 or $senha=='cibele'){
?>
     <td align="center">
	 <a href="javascript:acao_deleta('<?php echo $row["id"] ?>')">
	 <i class="material-icons" style="font-size:16px; vertical-align:bottom; color:black;">delete</i></a>
    </td>
<?php
     } else {
?>
