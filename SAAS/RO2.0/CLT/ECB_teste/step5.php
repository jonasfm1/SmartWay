...
function dataentrega(rota, dataentrega, v) {
 

var teste = "scripts.php?acao=data_entrega&rota=" + rota + "&dt_entrega=" + dataentrega + "&v=" + v;
...
$query_where = "UPDATE passo SET ok='yes' WHERE (id='1' OR id='2' OR id='3' OR id='4' OR id='5')";
...
<table width="680px" border="1" cellspacing="2" cellpadding="2" class="bordasimples">
...
<tr>
    ...
    <font style="text-align: center; font-size:11px"><strong>&nbsp;MOTORISTA</strong></font>
...
if ($transp==''){
  $query1 = "select * from rotas where nome_rota!='' group by nome_rota order by nome_veiculo ASC";		
} else {
  $query1 = "select * from rotas where nome_rota!='' and transportadora='$transp' group by nome_rota order by nome_veiculo ASC";		
...
$data_entrega = $row1["data_entrega"];
$nome_veiculo =  $row1["nome_veiculo"];
...
$query_verifica_integracao = mysql_query("select integrado from veiculos where nome='$integrado'");

$integra = mysql_fetch_array($query_verifica_integracao);

$verifica_integra =  $integra['integrado'];
...
<table width="680px" border="1" cellspacing="2" cellpadding="2" class="bordasimples">
  <tbody>
    <tr>
     <td height="40px" align="left" width="100%" style="font-weight:bold;background-color: #ECECEC; padding-left:5px;" colspan="5"><font color="#000000" size="3"><input type="checkbox" value="<?=$nome_rota?>" class="marcar" name="check_list[]" id="check_list"  />&nbsp;&nbsp;<?php echo $nome_veiculo; ?></font></td>

     
<td rowspan="2"  style="padding-left: 15px;">

<table class="bordasimples1">
<tr>
<td >
<i class="material-icons" style="font-size:22px; vertical-align:bottom; color:black;">calendar_month</i>

</td>
<td>
<div class="input-group date data_formato" data-date-format="dd-mm-yyyy">
  <input type="text" class="form-control" name="data" id="data<?php echo $nome_rota ?>" value="<?php echo $data_entrega ?>" style="width: 70px;height: 25px; font-size:11px;font-weight: bold;"  onchange="javascript:dataentrega('<?php echo $nome_rota ?>', document.getElementById('data<?php echo $nome_rota ?>').value, '<?php echo $nome_veiculo;?>')">
...
<?php 
     if($verifica_integra==1){
?>
     <td rowspan="2" style="padding-left: 5px; padding-right: 5px; background-color:#ECECEC">
     <i class="material-icons" style="font-size:22px; vertical-align:bottom; color:green;">verified</i>
    </td>
<?php
     } else {
?>
     <td rowspan="2"  style="padding-left: 5px; padding-right: 5px; background-color:#ECECEC">
     <i class="material-icons" style="font-size:22px; vertical-align:bottom; color:red;">warning</i>
    </td>
<?php
  ...
  <tr>  
    <td height="20px" align="left" style="font-weight:bold; padding-left:5px;"><font color="#000000" size="1">VISITAS: <?php echo $conta_i; ?></td>
     <td height="20px" align="left" style="font-weight:bold; padding-left:5px;"><font color="#000000" size="1">PEDIDOS: <?php echo $data['total']; ?></td>     
     <td height="20px" align="left" style="font-weight:bold; padding-left:5px;"><font color="#000000" size="1">PESO: <?php echo $data['peso']; ?></td>      
     <td height="20px" align="left"  style="font-weight:bold; padding-left:5px;"><font color="#000000" size="1">VOLUME: <?php echo $data['volume']; ?></td>     
     <td height="20px" align="left" style="font-weight:bold; padding-left:5px;"><font color="#000000" size="1">VALOR: <?php echo $data['valor']; ?></td>
...
<td align="left" nowrap="nowrap"><?= mb_strimwidth($row["bairro"], 0, 30, "...");?></td>
<td align="left" nowrap="nowrap"><?= $row["cidade"] ?></td>
<td align="left" nowrap="nowrap"><?= $row["cep"] ?></td>
<td align="left" nowrap="nowrap"><?= $row["uf"] ?></td>
...
<div id="mySidenav" class="sidenav">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" style="padding-top: 25px; padding-bottom: 8px; width:100%" >
		<tr >
            ...
            <strong><font size="4">&nbsp;INTEGRAÇÃO</font></strong>
            </td>
	   </tr>
        </table>
    
        <hr size = 1 width = '130px' color="#ECECEC" >
        <br> <br>
<form action="scripts.php?acao=integracao_erp" method='POST' id='form1'>
...
<tr>
    ...
    <font style="text-align: center"><strong>&nbsp;&nbsp;BAIXA DOS ROMANEIOS</strong></font>
    </a>
    </td>
    </tr>

        </table>
  <table border='0' style="text-align: left; font-size:11px; width:192px;margin-left:36px" nowrap="nowrap">


    <tr>
    <td>
      <i class="material-icons" style="font-size:22px; vertical-align:bottom">alarm</i>
      </td>
   
    <td style="vertical-align:center ;">
        <font style="text-align: center;font-size: 11px;" ><strong>&nbsp;&nbsp;DATA NO APP</strong></font>
        </td>
   
<td>

    <div class="input-group date data_formato" data-date-format="dd-mm-yy">
  <input type="text" class="form-control" name="data" value="<?php echo date('d-m-y', strtotime('+1 days')) ?>" style="width: 60px;height: 20px; font-size:11px;color:#cc0000;font-weight: bold;" >
       <span class="input-group-addon" >
         <span class="glyphicon glyphicon-th" style="height: 10px;font-size:11px;"></span>
       </span>
     </div>
     <input type="text" name="usuario" value="<?php echo $logado?>" hidden>
</td>
</form>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" style="padding-top: 25px; padding-bottom: 8px; width:100%" >
		<tr >
            ...
            <td align="left" valign="middle" nowrap="nowrap" style="width:100%; color:#000000;">
            <strong><font size="4">&nbsp;MONITORAMENTO</font></strong>
            </td>
	   </tr>
        </table>
        ...
        <br> <br>
        <table border="0" style="text-align: left; padding-left:10px" >

    <tr>
	<td nowrap="nowrap" style="width: 20px">
	<i class="material-icons" style="font-size:22px; vertical-align:bottom">browser_updated</i>
    </td>
    <td nowrap="nowrap">
  <form action="#" method="get" name="myForm" id="myform">
    <a href="../../../MO2.0/index.php?l=<?php echo $_SESSION['login'] . '@' . $_SESSION['login']; ?>&s=ecb123" target="_blank">
    <font style="text-align: center">&nbsp;&nbsp;ACESSAR MONITORAMENTO</font>
    </a>
    </form>
    </td>
    </tr>
