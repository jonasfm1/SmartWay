...
<table border="0" color:#000000;"  cellpadding="0" cellspacing="0">
   ...
   <table cellpadding="0" cellspacing="0">
	  <tr>
         ...
         <form action="scripts.php?acao=bloqueia_veiculos_todos_g" name="bloquear" id='bloquear' method="post">
...
<form action="scripts.php?acao=libera_veiculos_todos_g" name="libera" id='libera' method="post">
