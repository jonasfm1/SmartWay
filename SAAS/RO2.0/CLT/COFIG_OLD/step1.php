...
//while (($data = fgetcsv($handle, 1000, ';')) != FALSE) {
  ...
  $rowData = $sheet->rangeToArray('A' . $row_x . ':' . $highestColumn . $row_x, NULL, TRUE, FALSE);


   

    //echo $highestColumn;
    $coluna_01 = str_replace("'", " ", $rowData[0][9]);	//
   // echo $coluna_01;
  }
...
$data_0 = str_replace("'", " ", $rowData[0][9]);	//COD CLIENTE

$data_1 = str_replace("'", " ", $rowData[0][8]); 	//NOME CLIENTE
$data_1 = preg_replace( "/\r|\n/", "", $data_1);
$data_1=str_replace("/", "-", $data_1);	//
$data_1=str_replace('\\', '/',  $data_1); 
$data_1 = tirarAcentos($data_1);

$data_2 = str_replace("'", " ", $rowData[0][50]);	//ENDERECO
...
$data_3 = str_replace("'", " ", $rowData[0][12]);	//CIDADE
...
$data_4 = str_replace("'", " ", $rowData[0][13]);	//UF
$data_4 = preg_replace( "/\r|\n/", "", $data_4);
$data_4 = tirarAcentos($data_4);

$data_5 = str_replace("'", " ", $rowData[0][20]);	//CEP
$data_5 = preg_replace( "/\r|\n/", "", $data_5);

$data_6 = str_replace(",", ".", $rowData[0][39]);	//PESO
$volume = str_replace(",", ".", $rowData[0][41]);	//VOLUME
$data_7 = str_replace(",", ".", $rowData[0][40]);	//VALOR
$data_7 = ltrim($data_7, 'R$ ');

$data_8 = str_replace(",", ".", $rowData[0][1]);	//CODIGO DO PEDIDO
$data_8 = preg_replace( "/\r|\n/", "", $data_8);

$data_9 = str_replace("'", " ", $rowData[0][43]);	//OBS DO PEDIDO
...
$data_12 = str_replace(",", ".", $rowData[0][5]);	//BAIRRO
...
$data_13 = str_replace(",", ".", $rowData[0][12]);	//CLASSIFICAO
...
if ($data_6==0 and $data8==0){
//VALORES ZERADOS NO PESO VOLUME VALOR//////
$import="INSERT into clientes(codigo_cliente, nome, endereco, cidade, estado, cep, peso, volume, valor, codigo_pedido, obs_pedido, premium, classificacao, bairro, data_pedido)values('$data_0','$data_1','$data_2','$data_3','$data_4','$data_5','0,01','0.01', '0.01', '$data_8', '$data_9', '$premium', '$data_14', '$data_12', '$data_14')";
...
$import="INSERT into clientes(codigo_cliente, nome, endereco, cidade, estado, cep, peso, volume, valor, codigo_pedido, obs_pedido, premium, classificacao, bairro, data_pedido)values('$data_0','$data_1','$data_2','$data_3','$data_4','$data_5','$data_6', '$volume', '$data_7', '$data_8', '$data_9', '$premium', '$data_14', '$data_12', '$data_14')";
...
<td><p style="font-size:12px"><strong>ARQUIVO "<?php echo $filename; ?>" LIDO!</p></td>
...
<tr style="vertical-align: button">
<td><p style="padding-bottom: 5px;"><strong><font size="4" color="#ff0000">ATENÇÃO! </strong></p></font><p style="font-size: 11px;">PARA INICIALIZAR OS TRABALHOS DO DIA CLIQUE EM "EXCLUIR ROMANEIOS ANTERIORES" PARA LIBERAR OS VEÍCULOS PARA NOVAS ROTAS! ISSO SÓ SERÁ FEITO NA PRIMEIRA IMPORTAÇÃO DO DIA!</font></p></td>
</tr>

<tr style="height: 70px;">

<td > <input type="button" value="EXCLUIR ROMANEIOS ANTERIORES"  onclick="location.href='scripts.php?acao=limpa_romaneios';"></td>
...
<td ><p style="font-size:12px">&nbsp;&nbsp;IMPORTAR LISTA.</p></td>
