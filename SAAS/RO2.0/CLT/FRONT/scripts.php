...
while ($row = mysql_fetch_array($seleciona)) {
		...
		if($total_integrado>0){
			...
			$import2="INSERT into pedidos_input(pedido)values('$codigo_pedido')";
    ...
    <div class="modal-content">
      <div class="modal-header">
		  <table>
			  <tr>
				  <td>
				  <span class="material-icons" style="font-size: 48px;color:#2867b2">unarchive</span>
				  </td>
				  <td>
...
case 'cadastra_rotas_cadd':
	...
	if($transp==''){
		...
		$query3 = "UPDATE rotas SET veiculo='$i_id_veiculo[$y]', transportadora='$transp', nome_rota='$somadata_rota', ordem='$i_ordem[$y]', distancia='$i_distancia[$y]', tempo='$i_tempo[$y]', tempo_servico='$data_hoje', data_entrega='$data_hoje' WHERE id = '$i_id_cliente[$y]'";
