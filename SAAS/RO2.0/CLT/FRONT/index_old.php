...
<div id="ou">OU</div>
<div id="apDiv8">
  <input name="login" type="text" id="login" style="width:274px" value="Login" onclick="this.value='';"onblur="javascript:if (this.value=='') {this.value='Login'};"/>
</div>  
...
<div id="apDiv10">
  <input name="senha" type="password" style="width:274px" id="senha" value="Senha" onclick="this.value='';"onblur="javascript:if (this.value=='') {this.value='Senha'};"/>
  </div>
