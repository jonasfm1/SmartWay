...
<td>
  ...
  <input type="text" class="form-control" name="data" value="<?php echo date('d-m-y') ?>" style="width: 170px;height: 25px; font-size:11px;font-weight: bold;" >
       <span class="input-group-addon" >
         <span class="glyphicon glyphicon-th" style="height: 10px;font-size:11px;"></span>
       </span>
     </div>
  ...
  <form action="#" method="get" name="myForm" id="myform">
    <a href="../../../MO2.0/index.php?l=<?php echo $_SESSION['login'] . '@' . $_SESSION['login']; ?>&s=cofig123" target="_blank">
