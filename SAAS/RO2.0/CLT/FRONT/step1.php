...
/// TITULOS ////////////////
  ...
  $codigo_cliente_t = array_search("IdEntidade", $array_titulo); // $key = 9;
  $nome_cliente_t = array_search("DsEntidade", $array_titulo); // $key = 10;
  ...
  $cep_cliente_t = array_search("IdCep", $array_titulo); // $key = 20;
  ...
  $codigo_pedido_t = array_search("IdPedido", $array_titulo); // $key = 1;
  $obs_pedido_t = array_search("COMENTARIO", $array_titulo); // $key = 43;
  $bairro_pedido_t = array_search("Bairros", $array_titulo); // $key = 5;

  $classificacao_pedido_t = array_search("IncluidoEm", $array_titulo); // $key = 30;

  $motivo_reentrega = array_search("IdMotivoReentrega", $array_titulo); // $key = 36;

  $setor = array_search("DsSetorEntrega", $array_titulo); // $key = 9;
//////////////////////////////
...
if ($data_setor=='E_FACILY'){
  $premium = 'V';
} else if($data_setor=='E_ML'){
  $premium = 'I';
} else if($data_setor=='RETIRA'){
$premium = 'A';
} else if ($data_reentrega!=0){
  $premium = 'Y';
}
else {
  $premium = 'S';
...
// NAO TEM NO CLIENTES
      ...
      if($data_reentrega!=0){
        ...
        $import="INSERT into clientes(codigo_cliente, nome, endereco, cidade, estado, cep, peso, volume, valor, codigo_pedido, obs_pedido, premium, classificacao, bairro, data_pedido, setor)values('$data_0','$data_1','$data_2','$data_3','$data_4','$data_5','$data_6', '$volume', '$data_7', '$data_8', '$data_9', '$premium', '$data_14', '$data_12', '$data_14', '$data_setor')";
...
<tr>
<td ></td>
<td><p style="font-size:11px"><span style="color: #FF0000;font-weight: bold;">&nbsp;&nbsp;Libera todos os veículos para novos pedidos e exclui os pedidos já integrados.</span></p></td>
</tr>
<tr>
...
<tr>
<td ></td>
<td><p style="font-size:11px"><span style="color: #FF0000;font-weight: bold;" >&nbsp;&nbsp;Adiciona pedidos a lista já importada, sem perder as cargas feitas anteriormente.</span></p></td>
</tr>
