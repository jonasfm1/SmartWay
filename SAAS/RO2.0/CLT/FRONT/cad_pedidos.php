...
<div id="total">
   ...
   <tr>
       ...
       <font size="4"><strong>&nbsp;CONTROLE DE PEDIDOS -</strong></font>
...
echo "Banco de dados ainda vazio!";
 ...
 $query_novo = "select * from pedidos_input where $_qual like '%$_palavra%' ";
 $rs_novo = mysql_query($query_novo);

if ($_palavra==""){
	echo "<font size='2'>" . "Consulta no Pedidos ainda vazia!<br><br> Escolha <strong>Filtrar por Código</strong> e clique no botão 'PROCURAR'!" . "</font>";
} else {
if(mysql_num_rows($rs_novo)>0){
?>

<table border="3" id="demo" name="demo" class="tablesorter" style="width: 318px;">
<thead>
...
<th nowrap="nowrap" headers="icone" bgcolor="#00000" style="color:#000000; width:72px" class="drag-enable" title="EXCLUIR">
...
<a href="javascript:confirmaExclusao('scripts.php?acao=libera_pedido_input&id=<?php echo $row["id"] .'&what=' . $_qual .'&like=' . $_palavra ?>')"  title="Liberar pedido"><span class="material-icons" style="font-size: 14px;">check_circle</span></a>
</td>
