	//////////////////////CALCULA KMS GOOGLEMAPS SERVICE (100.000)

var distancia;
//var km;

   function CalculaDistancia(origem1, origem2, destino1, destino2) {
	    var origem = origem1 + ", " + origem2;
	    var destino = destino1 + ", " + destino2;
	...
	function callback(response, status) {
       ...
       if (status == google.maps.DistanceMatrixStatus.OK) {
		...
		document.getElementById('dis').innerHTML+= km +", ";
		//alert(km);
		//return km;
	...
	/*
				// CRIAR O ARRAY DAS LINHA
				 guarda_haversine.push({
					    ...
					    "inicio": one_inicio_d +", "+two_inicio_d,
				 });
				 */
				...
				// CRIAR O ARRAY DAS LINHA
	 			guarda_haversine2.push({
						...
						"cor_veiculo": junta_cor_veiculo,
						"quem_veiculo": junta_nome_veiculo,
						"inicio1": one_inicio_d,
						"inicio2": two_inicio_d,
						"final1": one_final_d,
						"final2": two_final_d,
				 });
...
///////////////////////////////////////////////////////////////////
		  ...
		  //alert(guarda_haversine[0].distancia);
	//
	//alert(kms);
	...
	//	alert(novo_haversine[0].inicio1);
	//	alert(novo_haversine[0].final1);
	    CalculaDistancia(novo_haversine[0].inicio1, novo_haversine[0].inicio2, novo_haversine[0].final1, novo_haversine[0].final2);
...
while (novo_haversine.length > 0) {
		...
		/////////////////////////////////////////////////////////////////////////////////////
			...
			novo_sorteio.push({
						...
						"inicio1": one_inicio_guardado,
						"inicio2": two_inicio_guardado,
						"final1": one_final_d2,
						"final2": two_final_d2
			 			});
		...
		if (novo_haversine.length===0) {
			...
			if(segura_ai_cor===undefined){
					...
					CalculaDistancia(one_inicio_guardado, two_inicio_guardado, one_final_ok1, two_final_ok1);
					
					
						if(distancia_final > 40){
						total_tempo += distancia_final / 1.1;
						tempo_cada_um = distancia_final / 1.1;
						} else {
						total_tempo += distancia_final / 0.6;
						tempo_cada_um = distancia_final / 0.6;
						}
						
						
					array_distancia_total += distancia_final * 1.2; 
		...
		/////////////////////////////////////////////////////////////////////////
			...
			if(distancia_todos > 40){
				total_tempo +=  distancia_todos / 1.1;
				tempo_cada_um = 	distancia_todos / 1.1;
				
			} else {
				total_tempo +=  distancia_todos / 0.6;
				tempo_cada_um = distancia_todos / 0.6;
			}
	
			
			array_distancia_total += distancia_todos * 1.2;
	...
	//LINHA INICIO//////////////////////////////////////////////////////////////////////////////
		...
		distancia_inicio = haversine(one_inicio, two_inicio, one_final, two_final);
			...
			if(distancia_inicio > 40){
				total_tempo +=  distancia_inicio / 1.1;
				tempo_cada_um = 	distancia_inicio / 1.1;
			} else {
				total_tempo +=  distancia_inicio / 0.6;
				tempo_cada_um = 	distancia_inicio / 0.6;
			}
...
//////////////////////////////////////////////////////////////
 ...
 ///////////////////////////////////////////////////////////	
	...
	////////////////////// PRIMEIRA VISITA VALORES //////////////////////////////
	 ...
	 guarda_primeiroponto_distancia= guarda_primeiroponto_distancia * 1.2;
					
	
	document.getElementById(vistitaae).innerHTML += "<br>";
	
	
	document.getElementById(vistitaae).innerHTML += "<p><strong>&nbsp;&nbsp;&nbsp;&nbsp;1 - </strong>" + pontos(guarda_primeiroponto_nomeveiculo, 25) + " - <strong>" + 	guarda_primeiroponto_distancia.toFixed(1) + " Km</strong></p>";
	...
	for (var w = 0; w < data_ok; w++) {
						...
						/*	/// zero antes do nemuro ate 10 ////
							...
							meu_distancia[i][w]= meu_distancia[i][w] * 1.2;
...
////////////////valor do retorno em km///////////////////////////
 				retorna_base = distancia_final * 1.2;
////////////////valor do retorno em km///////////////////////////
