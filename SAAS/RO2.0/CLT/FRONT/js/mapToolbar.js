...
//add a point to a poly, 'e' can be a click event or a latLng object
    ...
    addPoint : function(e, poly, index) {
	    var e = (typeof e.latLng != "undefined")? e.latLng : e,
		    image = new google.maps.MarkerImage('imgs/marker-edition.png',
		    new google.maps.Size(9, 9),
		    new google.maps.Point(0, 0),
		    new google.maps.Point(5, 5)),
	    imageover = new google.maps.MarkerImage('imgs/marker-edition-over.png',
		    new google.maps.Size(9, 9),
		    new google.maps.Point(0, 0),
		    new google.maps.Point(5, 5)),
			    path = poly.getPath(),
...
function initialize(container) {
	...
	map.setCenter(new google.maps.LatLng(-23.698607, -46.742706));
	map.setZoom(10);
