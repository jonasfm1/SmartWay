...
var teste = "scripts.php?acao=deleta_veiculo_g&veiculo=" + veiculo;


if(confirm('Você tem certeza que deseja esvaziar esse veículo? O veículo ficará livre e seus pedidos serão excluidos do Sistema.')) {
...
<script type="text/javascript">
    ...
    useBootstrap: false,
    title: 'Atençao!',
    content: 'Você tem certeza que deseja retirar a Roterização desse veículo? Seus pedidos e seu veiculo voltaram a aparecer no Passo 3 como não roterizados!',
    type: 'blue',
    typeAnimated: true,
...
?>
<a href="javascript:confirmaInativo('scripts.php?acao=libera_veiculo_g&id=<?php echo $row["id"];?>')"><span class="material-icons" style="font-size: 14px;">
check_box
</span></a>
<?php
} else {
?>
<a href="javascript:confirmaativo('scripts.php?acao=bloqueia_veiculo_g&id=<?php echo $row["id"];?>')"><span class="material-icons" style="font-size: 14px;">
...
<td nowrap="nowrap" align="center"><?php echo $row["transportadora"] ?></td>

<td nowrap align="center"><?php echo $row["tipo"] ?></td>
<td nowrap align="center"><?php echo $row["peso"] ?></td>
<td nowrap align="center"><?php echo $row["peso_total"] ?></td>
<td nowrap align="center"><?php echo $row["volume"] ?></td>
<td nowrap align="center"><?php echo $row["volume_total"] ?></td>
<td nowrap align="center"><?php echo $row["valor"] ?></td>
<td nowrap align="center"><?php echo $row["valor_total"] ?></td>
<?php 
     if($row["integrado"]==1){
?>
     <td align="center">
