...
for ($i = 0; $i < $mrk_cnt; $i++){
		...
		$ref_menor = mb_strimwidth($ref[$i], 0, 50, '...');
		$obs_menor = mb_strimwidth($obs_pedido[$i], 0, 50, '...');
		$endereco_menor = mb_strimwidth($endereco_cli_mesmo[$i], 0, 50, '...');
    	...
    	echo "mrktx$i = \"<div id='iw_container'><div class='iw_title' style='background-color:#589bd4'><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='30px'><img src='imgs/ico_realizado.png' width='22' height='22'/></td><td style='text-wrap:normal;width:400'>$string_menor[$i] ($id_cliente[$i])</td></tr></table></div><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='40px'></td><td style='padding-top:20px; padding-bottom:5px; font-size:11px'><strong>PEDIDO:</strong> $codigo_pedido[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><strong>PESO:</strong> $peso[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><strong>VOLUME:</strong> $volume[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><strong>VALOR:</strong> $valor[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px' title='$endereco_cli_mesmo[$i]'><strong>END.:</strong>$endereco_menor</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><strong>BAIRRO/CIDADE: </strong>$bairro[$i], $cidade[$i]</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px' title='$obs_pedido[$i]'><strong>OBS.: </strong>$obs_menor</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px' title='$ref[$i]'><strong>REF.: </strong>$ref_menor</td></tr><tr><td width='40px'></td><td style='padding-top:5px; padding-bottom:5px; font-size:11px'><a href='javascript:geo(id_cliente_js[$i])';> <i class='material-icons' style='font-size:20px; vertical-align:bottom'>edit_location_alt</i>&nbsp;LOCALIZAR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a><a href='javascript:editar(id_cliente_js[$i])';><i class='material-icons' style='font-size:20px; vertical-align:bottom'>edit</i>&nbsp;EDITAR</a></td></tr></table></div>\";";
