...
<br>
 <table width="100%" border="1" class="bordasimples" cellpadding="2" cellspacing="2">
    ...
    <tr style="text-transform:uppercase;font-weight: bold;color: #000000;" bgcolor="#ECECEC">
      ...
      <td  height="20" nowrap style="padding-top: 15px; padding-left:5px">Marca</td>
      ...
      <td   nowrap style="padding-top: 15px; padding-left:5px">NOTA FISCAL</td>
     ...
     <td  nowrap style="padding-top: 15px; padding-left:5px">Ref.</td>
    </tr>
<?php
...
?>
      ...
      <td  style="padding-left: 5px;" ><?php echo $valor ?></td>
        ...
        <td   style="padding-left: 5px;" ><?php echo $ref ?></td>
