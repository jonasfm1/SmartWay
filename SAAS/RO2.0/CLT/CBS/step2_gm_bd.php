...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#579bd3; font-size: 11px; color: white" >
    <tr>
		<td align="left" valign="center" colspan="3" height="50px"><i class="material-icons" style="font-size:22px; vertical-align:bottom;padding-left: 15px;">edit_location_alt</i><strong><font size="2px">&nbsp;LOCALIZAR CLIENTE NO BANCO DE DADOS - CLIENTE: <?php echo $_reg; ?></font></strong>  
      </td>
    </tr>
</table>
<br>
