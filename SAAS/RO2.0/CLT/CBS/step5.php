...
<td align="left" nowrap="nowrap" title="<?php echo $row["nota"];?>">
  <?= mb_strimwidth($row["nota"], 0, 20, "..."); ?>
...
<td align="left" nowrap="nowrap" title="<?php echo $row["ref"];?>">
  <?= mb_strimwidth($row["ref"], 0, 20, "..."); ?>
