...
for ($row =2; $row <= $highestRow; $row++)
	...
	$data_3a = str_replace("´", " ", $data_3a);
	$data_3a = str_replace("`", " ", $data_3a);
	$data_3a = str_replace("ç", "c", $data_3a);
	$data_3a = str_replace("Ç", "C", $data_3a);
	$data_3a =  str_replace(";", " ", $data_3a);
	$data_3a = preg_replace('/\s/',' ',$data_3a);
	$data_3a = str_replace("|", " ", $data_3a);
	...
	$data_10 = str_replace("´", " ", $data_10);
	$data_10 = str_replace("`", " ", $data_10);
	$data_10 = str_replace("ç", "c", $data_10);
	$data_10 = str_replace("Ç", "C", $data_10);
	$data_10 =  str_replace(";", " ", $data_10);
	$data_10 = str_replace("|", " ", $data_10);
	...
	$data_13 = str_replace(",", ".", $rowData[0][15]);	//PONTO REFERENCIA
	$data_13 = preg_replace( "/\r|\n/", "", $data_13);
	$data_13 = str_replace("*"," ", $data_13);
	$data_13 = str_replace("´", " ", $data_13);
	$data_13 = str_replace("`", " ", $data_13);
	$data_13 = str_replace("ç", "c", $data_13);
	$data_13 = str_replace("Ç", "C", $data_13);
	$data_13 =  str_replace(";", " ", $data_13);
	$data_13 = preg_replace('/\s/',' ',$data_13);
	$data_13 = str_replace("|", " ", $data_13);
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	$import="INSERT into clientes(codigo_cliente, nome, endereco, cidade, estado, cep, peso, volume, valor, codigo_pedido, obs_pedido, premium, marca, tipo_nota, nota, ref)values('$concatena_codcli','$data_1','$data_3a','$data_3','$data_4','$data_5','0.01','0.00','0.00','$data_9','$data_10', '$premium','$data_12','$nota','$numero_nota','$data_13')";
	...
	$import="INSERT into clientes(codigo_cliente, nome, endereco, cidade, estado, cep, peso, volume, valor, codigo_pedido, obs_pedido, premium, marca, tipo_nota, nota, ref)values('$concatena_codcli','$data_1','$data_3a','$data_3','$data_4','$data_5','$data_6','$data_7','$data_8','$data_9','$data_10', '$premium','$data_12','$nota','$numero_nota','$data_13')";
