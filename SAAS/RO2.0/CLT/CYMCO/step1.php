...
$data_2 = str_replace("'", " ", $rowData[0][2]);	//ENDERECO
...
$numero= str_replace("'", " ", $rowData[0][3]);	//numero
$data_2 = $data_2 . ", " . $numero;
$data_2 = tirarAcentos($data_2);

$data_3 = str_replace("'", " ", $rowData[0][5]);	//CIDADE
...
$data_4 = str_replace("'", " ", $rowData[0][6]);	//UF
...
$data_7 = str_replace(",", ".", $rowData[0][10]);	//VOLUME


$data_8 = str_replace(",", ".", $rowData[0][8]);	//CODIGO DO PEDIDO
$data_8 = preg_replace( "/\r|\n/", "", $data_8);

$data_9 = str_replace("'", " ", $rowData[0][4]);	//OBS DO PEDIDO
...
$data_12 = str_replace(",", ".", $rowData[0][12]);	//BAIRRO
...
$data_13 = str_replace(",", ".", $rowData[0][13]);	//CLASSIFICAO
...
$import="INSERT into clientes(codigo_cliente, nome, endereco, cidade, estado, cep, peso, volume, valor, codigo_pedido, obs_pedido, premium, classificacao, bairro)values('$data_0','$data_1','$data_2','$data_3','$data_4','$data_5','$data_6','$data_7', '0.01', '$data_8', '$data_9', '$premium', '$data_13', '$data_12')";
