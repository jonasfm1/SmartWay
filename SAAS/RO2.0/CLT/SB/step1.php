...
for ($row =2; $row <= $highestRow; $row++)
	...
	if($data_13==""){
		$classific= "SEM CLASSIFICACAO";

	}

   if ($data_13=="KIT TERNURA" or $data_13=="MAGIA" or $data_13=="SUPER" or $data_13=="IDEAL" or $data_13=="BRILHANTE" or $data_13=="LUZ SEM ALCOOL" or $data_13=="SIMPATIA" or $data_13=="FANTASIA" or $data_13=="SORRISO" or $data_13=="EMOCAO" or $data_13=="PARAISO" or $data_13=="GRATIDAO" or $data_13=="CONFORTO" or $data_13=="ALEGRIA" or $data_13=="FELICIDADE SEM " or $data_13=="ELEGANCE" or $data_13=="CLASSICA" or $data_13=="HARMONIA" or $data_13=="LORD" or $data_13=="PREMIUM" or $data_13=="NOITE DE GALA" or $data_13=="AUTENTICA" or $data_13=="FESTEJAR" or $data_13=="CELEBRAR" or $data_13=="PIC-NIC" or $data_13=="ILHA" or $data_13=="PRAIA" or $data_13=="CAMPO COOLER BO" or $data_13=="ESTOJO PRATA" or $data_13=="ESTOJO PALADIO" or $data_13=="ESTOJO TITANIO"){
...
$query_where_verifica =  mysql_query("SELECT obs_pedido from clientes where obs_pedido='$data_10'");
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	$import="INSERT into clientes(codigo_cliente, nome, endereco, cidade, estado, cep, peso, valor, codigo_pedido, obs_pedido)values($concatena_codcli,'ERRO','ERRO','ERRO','ERRO','ERRO','ERRO','ERRO','ERRO','ERRO')";
	} 
	...
	$import="INSERT into clientes(codigo_cliente, nome, endereco, cidade, estado, cep, peso, valor, codigo_pedido, obs_pedido)values('ERRO','ERRO','ERRO','ERRO','ERRO','ERRO','ERRO','ERRO','ERRO','ERRO')";
	} 
	

	if ($data_6==0 and $data_7==0 and $data_8==0){
	//VALORES ZERADOS NO PESO VOLUME VALOR//////
	$import="INSERT into clientes(codigo_cliente, nome, endereco, cidade, estado, cep, peso, volume, valor, codigo_pedido, obs_pedido, premium, marca, tipo_nota)values('$concatena_codcli','$data_1','$data_3a','$data_3','$data_4','$data_5','0.01','0.00','0.00','$data_9','$data_10', '$premium','$data_12','$nota')";
	...
	$import="INSERT into clientes(codigo_cliente, nome, endereco, cidade, estado, cep, peso, volume, valor, codigo_pedido, obs_pedido, premium, marca, tipo_nota, classificacao, emails)values('$concatena_codcli','$data_1','$data_3a','$data_3','$data_4','$data_5','$data_6','$data_7','$data_8','$data_9','$data_10', '$premium','$data_12','$nota','$classific','$emails')";
