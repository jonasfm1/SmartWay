...
<td align="left" nowrap="nowrap"><?= $row["lote"] ?></td>
<td align="left" nowrap="nowrap"><?= $row["vendedor"] ?></td>
<td align="left" nowrap="nowrap"><?= $row["praca"] ?></td>
<td align="left" nowrap="nowrap"><?php echo $row["setor"] ?></td>
...
<tr>
    ...
    <a href="export_csv.php?acao=export_xls2" >
    <font style="text-align: center">&nbsp;&nbsp;BAIXAR POR PEDIDO</font>
    </a>
    </td>
    </tr>
    <tr>
    ...
    <a href="export_csv.php?acao=export_xls3" >
    <font style="text-align: center">&nbsp;&nbsp;BAIXAR POR LOTE</font>
    </a>
    </td>
    </tr>
...
<td>
  ...
  <form action="#" method="get" name="myForm" id="myform">
    <?php
      if ($logado=='slt_i2'){
        ?>
          <a href="../../../MO2.0/index.php?l=slt2@slt2&s=slt123" target="_blank">
    <font style="text-align: center">&nbsp;&nbsp;ACESSAR MONITORAMENTO</font>
    </a>
<?php
      } else{
?>
    <a href="../../../MO2.0/index.php?l=slt@slt&s=slt123" target="_blank">
    <font style="text-align: center">&nbsp;&nbsp;ACESSAR MONITORAMENTO</font>
    </a>
  <?php
      }
