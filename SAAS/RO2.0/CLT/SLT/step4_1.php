...
if(!empty($_GET['check_list'])){
     foreach($_GET['check_list'] as $report_id){
		...
		while($row = mysql_fetch_array($rs1)){
			...
			$bairro_cliente[$conta1_new] = $row["bairro"];		
			$lote_cliente[$conta1_new] = $row["lote"];
	
			$vendedor_cliente[$conta1_new] = $row["vendedor"];
			
			$especial[$conta1_new] = $row["especial"];
			$praca[$conta1_new] = $row["praca"];

			//echo $veiculo_cliente[$conta1];
			$query3 = "INSERT INTO rotas(codigo_cliente, nome_cliente, lat, lgn, veiculo, nome_veiculo, tipo_veiculo, endereco, bairro, cep, cidade, codigo_pedido, obs_pedido, tempo_servico, peso, volume, valor, setor, marca, uf, lote, vendedor, especial, praca) VALUES('$codigo_cliente[$conta1_new]', '$nome_cliente[$conta1_new]', '$lat_cliente[$conta1_new]', '$lgn_cliente[$conta1_new]', '$veiculo_cliente[$conta1_new]', '$nome_veiculo', '$tipo', '$endereco_cliente[$conta1_new]', '$bairro_cliente[$conta1_new]', '$cep_cliente[$conta1_new]', '$cidade_cliente_fora[$conta1_new]', '$codigo_pedido[$conta1_new]', '$obs_pedido[$conta1_new]', '$temposervico_cliente[$conta1_new]', '$peso_cliente[$conta1_new]', '$volume_cliente[$conta1_new]', '$valor_cliente[$conta1_new]', '$setor_cliente[$conta1_new]', '$marca_cliente[$conta1_new]', '$uf[$conta1_new]', '$lote_cliente[$conta1_new]', '$vendedor_cliente[$conta1_new]', '$especial[$conta1_new]', '$praca[$conta1_new]')";
			
			
		//	$query3 = "INSERT INTO rotas(codigo_cliente, nome_cliente, lat, lgn, veiculo, endereco, bairro, cep, cidade, codigo_pedido, obs_pedido, tempo_servico, peso, volume, valor, setor, lote, vendedor, especial, praca) VALUES('$codigo_cliente[$conta1_new]', '$nome_cliente[$conta1_new]', '$lat_cliente[$conta1_new]', '$lgn_cliente[$conta1_new]', '$veiculo_cliente[$conta1_new]', '$endereco_cliente[$conta1_new]', '$bairro_cliente[$conta1_new]', '$cep_cliente[$conta1_new]', '$cidade_cliente_fora[$conta1_new]', '$codigo_pedido[$conta1_new]', '$obs_pedido[$conta1_new]', '$temposervico_cliente[$conta1_new]', '$peso_cliente[$conta1_new]', '$volume_cliente[$conta1_new]', '$valor_cliente[$conta1_new]', '$setor_cliente[$conta1_new]', '$lote_cliente[$conta1_new]', '$vendedor_cliente[$conta1_new]', '$especial[$conta1_new]', '$praca[$conta1_new]')";
