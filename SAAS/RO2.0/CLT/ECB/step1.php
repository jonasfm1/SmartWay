...
$deleterecords3 = "DELETE FROM cidade"; //Esvaziar a tabela classificacao
...
while ($row_city = mysql_fetch_array($rs_city)) {
   $cidade =  $row_city['cidade'];


//echo $row_classifica['classificacao'];
$query_city_db = "INSERT into cidade(cidade) values ('$cidade')";
$rs_city_db= mysql_query($query_city_db);
