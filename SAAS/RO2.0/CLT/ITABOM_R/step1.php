...
$data_0 = str_replace("'", " ", $rowData[0][3]);	//COD CLIENTE
$pieces = explode("/", $data_0);
$data_0 =  $pieces[0];


$data_1 = str_replace("'", " ", $rowData[0][2]); 	//NOME CLIENTE
$data_1 = preg_replace( "/\r|\n/", "", $data_1);

$data_1 = tirarAcentos($data_1);


$data_3 = str_replace("'", " ", $rowData[0][29]);	//CIDADE
...
$data_6=str_replace('.', "", $rowData[0][8]);	//
$data_6 = str_replace(",", ".", $data_6);	//PESO
...
$data_pedido = str_replace(",", ".", $rowData[0][1]);	//data pedido
$data_pedido = preg_replace( "/\r|\n/", "", $data_pedido);

$data_9 = str_replace("'", " ", $rowData[0][31]);	//OBS DO PEDIDO
...
$data_13 = str_replace(",", ".", $rowData[0][8]);	//CLASSIFICAO
...
if (is_numeric($data_6)) { 
  ...
  if ($data_6>=10000 AND $data_6<20000){
  $premium = '39FF14';
    
  }
  if ($data_6<10000 AND $data_6>=5000){
  $premium= 'FF0000';
...
$import="INSERT into clientes(codigo_cliente, nome, endereco, cidade, estado, cep, peso, volume, valor, codigo_pedido, obs_pedido, premium, classificacao, data_pedido)values('$data_0','$data_1','$data_2','$data_3','$data_4','$data_5','$data_6','0.01', '0.01', '$data_8', '$data_9', '$premium', '$data_13', '$data_pedido')";
...
$query2 = "UPDATE clientes SET latitude_cad='$lat_cad', longitude_cad='$lgn_cad', confianca_cad='$confianca_cad', codigo_db_geral='$codigo', endereco='$end_cad', estado='$uf' WHERE codigo_cliente = '$id_cliente'";
