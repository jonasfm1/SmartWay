...
<div class="menu">
  <ul class="menu-list">
    ...
    <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>CONFIGURAÇÕES EM GERAL</strong></li>      
        ...
        <li><a href="regioes_control.php">Controle de regiões</a></li>  
         <li><a href="transp_control.php">Controle de transportadoras</a></li>      
...
<div id="apDiv3">
<div id="mouse">
<span style="cursor:pointer" onclick="openNav()"><img src="imgs/logo_min.png" width="48" height="33" alt=""/></span>
</div>
   </div>
