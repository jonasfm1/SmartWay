...
$query_q = "select nome_veiculo, SUM(peso) AS peso_total, SUM(volume) AS volume_total, SUM(valor) AS valor_total, reordenar, veiculo, concat(lat) from rotas group by nome_veiculo order by prioridade ASC";
