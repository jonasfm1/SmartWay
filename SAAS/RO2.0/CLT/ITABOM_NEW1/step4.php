...
<form name="go_step4a" action="scripts.php?acao=grava_lat_lgn_veiculo" method="POST" >
   ...
   <table width="15%" border="0" cellpadding="0" cellspacing="0" style="padding-top: 0px; padding-bottom: 10px; margin-top: 5px; color: #000000;" bgcolor="#FFFFFF">
		<tr>
    <td nowrap>
			<input type="checkbox" onClick="validate()" name='trans_ok' id='trans_ok'/><font size='1'>&nbsp;&nbsp;PARA TODAS AS ROTAS(PONTO INCIAL/FINAL)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font><br/>
		</td>
    <td nowrap>
			<font size='1'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>PONTO INICIAL</b></font>
      <label>
<select name="inicio_transbordo">
<?php 
...
?>
  ...
  ?>
    ...
    <td nowrap>
			<font size='1'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>PONTO FINAL</b></font>
      <label>
<select name="final_transbordo">
<?php 
...
<div align="center" >PRIORIDADE</div>
</th>
</tr>
</thead>
<tbody>
...
<?php if ($tipo=="Moto"){ ?><img src="imgs/<?php echo "v06_" . $type_icon . ".png";  ?>" height="8px"/><?php } ?>
  ...
  <?php if ($tipo=="3-4"){ ?><img src="imgs/<?php echo "v05_" . $type_icon . ".png";  ?>" height="8px"/><?php } ?>
</td>
