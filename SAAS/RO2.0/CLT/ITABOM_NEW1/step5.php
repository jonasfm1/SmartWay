...
if ($transp==''){
  ...
  $query1 = "select * from rotas where nome_rota!='' and transportadora='$transp' group by prioridade order by nome_rota ASC";		
...
<div id="mySidenav" class="sidenav">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" style="padding-top: 25px; padding-bottom: 8px; width:100%" >
		<tr >
            ...
            <strong><font size="4">&nbsp;INTEGRAÇÃO PROTHEUS</font></strong>
            </td>
	   </tr>
        </table>
    
        <hr size = 1 width = '240px' color="#ECECEC" >
        <br> <br>
