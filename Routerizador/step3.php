...
<td align="center"  nowrap='nowrap'  title="EXCLUIR DO VEICULO"> 
<a href="javascript:confirmaExclusao('scripts.php?acao=exclui_cliente_veiculo&id=<?php echo $row1["codigo"] . "&veiculo=" . $id1 . "&p=" . $row1["peso"] . "&v=" . $row1["volume"] . "&va=" . $row1["valor"]; ?>')"><i class="material-icons" style="font-size:14px">car_crash</i></a>
</td>
</tr> 
...
<td align="center" nowrap='nowrap' title="EXCLUIR DO VEICULO"> 
<a href="javascript:confirmaExclusao('scripts.php?acao=exclui_cliente_veiculo&id=<?php echo $row["codigo"] . "&veiculo=" . $id1 . "&p=" . $row["peso"] . "&v=" . $row["volume"] . "&va=" . $row["valor"]; ?>')"><i class="material-icons" style="font-size:14px">car_crash</i></a>
</td>
</tr> 
 <?php
