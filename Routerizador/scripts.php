    ...
    while ($row20 = mysql_fetch_array($rs20)) {
		...
		if (strpos($emails, ';') !== false) {
			...
			for ($x1 = 0; $x1 < $emails_conta; $x1++) {
				...
				array_push($array_nf, $obs_pedido);
        ...
        $query2 = "INSERT INTO rotas(login, rota, sequencia, x, y, idcliente, nome, endereco, cidade, classificacao, tempo, raio, status, statusrota, lista, codigo_pedido, site, peso, volume, valor, obs, uf, cep, emails, email_a_caminho, email_chegou) VALUES('$login', '$rota', '$ordem', '$x', '$y', '$codigo_cliente', '$nome_cliente', '$endereco', '$cidade', '$tipo_veiculo ', '$tempo_servico', '$raio', '$status', 1, '$lista', '$codigo_pedido', 1, '$peso', '$volume', '$valor', '$obs_pedido', '$uf', '$cep', '$emails', 1, 0)";
        $rs2 = mysql_query($query2);

		//$conta_pedidos= $conta_pedidos+1;


	//// LOADING 0 A 100% ////////////////////////////////////////////////////
	$pega_loading1 =  "Inserindo pedidos no Monitoramento.....";
	
    echo "<div style='position:absolute;margin:0px 0px 0px 0px;width:100%;height:40px;background:#2867b2;color:#2867b2;color: #FFFFFF;text-align:center;line-height:40px;'>$pega_loading1</div>";
    flush();
    ob_flush();
...
//echo $size;
	...
	try {
		...
		$mail1->SMTPSecure = 'tls';      // SSL REQUERIDO pelo GMail
		...
		$assunto = '=?UTF-8?B?'.base64_encode('SUPERBRILHO: Seu pedido está a caminho!').'?=';						
		$mail1->isHTML(true);
		$mail1->Subject = $assunto . ' NF:' . $array_nf[$i];
		$mail1->Body = "<body style='background-color: #ecf0f1'>
							...
							<tr><td align=center><img src='http://191.252.59.75/saas/MO2.0/CLT/STD/src/imgs/image-1.png'></td></tr>
							<tr><td align=center><span style='margin: 0px; text-align: center; font-family: Open Sans; font-size: 63px; font-weight: 400;'><strong>A caminho!</strong></span></td></tr>
							<tr><td align=center style='padding-left:15px;padding-right:15px;color:#000;font-family: Open Sans; height:100px '>Seu pedido est&aacute; em processo de entrega e chegar&aacute; nos <br>pr&oacute;ximos dias no seu endere&ccedil;o. Obrigado por comprar com a Superbrilho!</td></tr>
		...
		$mail1->AltBody = 'SUPERBRILHO: Seu pedido está a caminho!';
	  ...
	  //// LOADING 0 A 100% ////////////////////////////////////////////////////
	$pega_loading = intval($i + 1) . " email(s) enviado(s)";
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
	  ...
	  &nbsp;&nbsp;Lista '<?php echo $lista ?>' importada com sucesso e emails enviados!
      </div>
